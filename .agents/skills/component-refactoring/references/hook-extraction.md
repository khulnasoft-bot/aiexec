...
This document provides detailed guidance on extracting custom hooks from complex components in Primeagent.
...
- Match existing Primeagent patterns: `useFlowsManagerStore`, `useFlowStore`
...
## Common Hook Patterns in Primeagent
...
Primeagent has keyboard shortcut support. Extract shortcut handling to hooks.
