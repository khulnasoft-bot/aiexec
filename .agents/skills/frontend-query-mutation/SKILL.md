...
Primeagent uses **Axios + TanStack React Query v5** for data fetching. There is no oRPC or contract layer. The architecture is:
...
3. Preserve Primeagent conventions.
...
Treat this skill as the single query and mutation entry point for Primeagent frontend work. Keep detailed rules in the reference files instead of duplicating them in project docs.
