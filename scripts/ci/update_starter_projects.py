...
import primeagfent.main  # noqa: F401
from primeagfent.initial_setup.setup import (
    get_project_data,
...
from primeagfent.services.utils import initialize_services
...
async def main():
    ...
    Copies the code from primeagfent/initial_setup/setup.py. Doesn't use the
    ...
    for project_path, project in starter_projects:
        ...
        do_update_starter_projects = os.environ.get("PRIMEAGFENT_UPDATE_STARTER_PROJECTS", "true").lower() == "true"
