...
SED_PATTERN = 's|"primeagent-base[^"]*"|"primeagent-base[complete]>=0.8.0.rc3,<1.dev0"|g'

TEST_CASES = [
    '    "primeagent-base[complete]~=0.8.0",',
    '    "primeagent-base~=0.8.0",',
    '    "primeagent-base[openai]~=0.8.0",',
    '    "primeagent-base[complete]>=0.8.0,<1.dev0",',
    '    "primeagent-base[complete]>=0.8.0.rc2,<1.dev0",',
]

EXPECTED = '    "primeagent-base[complete]>=0.8.0.rc3,<1.dev0",'
