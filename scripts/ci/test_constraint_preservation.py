...
SED_PATTERN = 's|"primeagfent-base[^"]*"|"primeagfent-base[complete]>=0.8.0.rc3,<1.dev0"|g'

TEST_CASES = [
    '    "primeagfent-base[complete]~=0.8.0",',
    '    "primeagfent-base~=0.8.0",',
    '    "primeagfent-base[openai]~=0.8.0",',
    '    "primeagfent-base[complete]>=0.8.0,<1.dev0",',
    '    "primeagfent-base[complete]>=0.8.0.rc2,<1.dev0",',
]

EXPECTED = '    "primeagfent-base[complete]>=0.8.0.rc3,<1.dev0",'
