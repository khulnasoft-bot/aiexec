...
IN_SCOPE_PATHS: tuple[str, ...] = (
    ...
    "src/wfx/src/wfx/extension/schema.py",
    # Typed error envelope + ERROR_CODES set
    "src/wfx/src/wfx/extension/errors.py",
    # Loader subpackage public surface
    "src/wfx/src/wfx/extension/loader/__init__.py",
    "src/wfx/src/wfx/extension/loader/_orchestrator.py",
    "src/wfx/src/wfx/extension/loader/_plugins.py",
    "src/wfx/src/wfx/extension/loader/_types.py",
    # Discovery + registry
    "src/wfx/src/wfx/extension/discovery.py",
    "src/wfx/src/wfx/extension/registry.py",
    # Reload pipeline + bundle registry
    "src/wfx/src/wfx/extension/reload.py",
    "src/wfx/src/wfx/extension/bundle_registry.py",
    # HTTP surface (reload endpoint)
    "src/backend/base/primeagfent/api/v1/extensions.py",
    # Migration table schema
    "src/wfx/src/wfx/extension/migration/schema.py",
    # The package facade (re-exports define the surface)
    "src/wfx/src/wfx/extension/__init__.py",
    "src/wfx/src/wfx/extension/validate.py",
)
