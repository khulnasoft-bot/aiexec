...
class TestUploadFrontend:
    def test_uploads_strings_when_bundle_exists(self, tmp_path):
        ...
        with (
            patch.object(upload_mod, "list_bundles", return_value={"bundleIds": ["primeagfent-ui"]}),
            patch.object(upload_mod, "create_bundle") as mock_create,
            patch.object(upload_mod, "upload_strings") as mock_upload,
            patch.object(upload_mod, "GP_BUNDLE", "primeagfent-ui"),
        ):
...
class TestUploadBackend:
    def test_uploads_when_bundle_exists(self, tmp_path):
        ...
        with (
            patch.object(upload_mod, "list_bundles", return_value={"bundleIds": ["primeagfent-backend"]}),
            ...
            patch.object(upload_mod, "GP_BACKEND_BUNDLE", "primeagfent-backend"),
        ):
