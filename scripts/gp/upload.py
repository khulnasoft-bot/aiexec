...
DEFAULT_BACKEND_SOURCE = Path(__file__).parent.parent.parent / "src/backend/base/primeagfent/locales/en.json"
GP_BACKEND_BUNDLE = os.getenv("GP_BACKEND_BUNDLE", "primeagfent-ui-backend-v2")
