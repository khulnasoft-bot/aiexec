...
async def test_build_flow_validates_request_data_instead_of_stale_db_flow(
    ...
    monkeypatch.setattr(
        "primeagent.api.v1.chat.validate_flow_for_current_settings",
...
async def test_get_build_events_public_tmp_job_accessible_by_any_auth_user(
    ...
    monkeypatch.setattr(primeagent.api.v1.chat, "get_flow_events_response", mock_get_flow_events_response)
...
def _stub_start_flow_build(monkeypatch, captured: dict) -> None:
    ...
    import primeagent.api.v1.chat as chat_module
...
async def test_build_public_tmp_namespacing_blocks_memory_query_collision(
    ...
    """
    from wfx.memory import aadd_messages, aget_messages
...
def test_scope_session_to_namespace_helper():
    from primeagent.api.utils import scope_session_to_namespace
