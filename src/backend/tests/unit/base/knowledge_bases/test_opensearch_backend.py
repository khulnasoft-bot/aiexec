...
import pytest
from wfx.base.knowledge_bases.backends import OpenSearchBackend
from wfx.base.knowledge_bases.backends.opensearch import (
    DEFAULT_TEXT_FIELD,
...
class TestOpenSearchSimilaritySearchFilterHandling:
    ...
    canonical case Primeagent itself relies on at
