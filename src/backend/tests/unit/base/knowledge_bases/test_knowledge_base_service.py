...
from primeagent.services.database.models.knowledge_base import KnowledgeBaseStatus
...
class TestNormalization:
    def test_record_to_metadata_dict_matches_json_shape(self):
        ...
        from primeagent.services.database.models.knowledge_base import KnowledgeBaseRecord
...
class TestBackfillFromDisk:
    ...
    async def test_backfill_uses_recounted_disk_stats(self, active_user, tmp_path: Path, monkeypatch):
        ...
        monkeypatch.setattr("primeagent.api.utils.kb_helpers.KBAnalysisHelper.get_metadata", fake_get_metadata)
...
class TestBackfillAllUsersFromDisk:
    async def test_backfill_all_users_scans_each_user_root(self, active_user, tmp_path: Path):
        ...
        from primeagent.services.deps import get_auth_service, session_scope
