...
import pytest
from wfx.base.mcp.util import MCPStdioClient, MCPStreamableHttpClient, update_tools
...
class TestMCPTimeoutConfiguration:
    ...
    async def test_stdio_client_default_timeout(self):
        ...
        with patch("wfx.base.mcp.util._get_mcp_setting") as mock_get_setting:
    ...
    async def test_update_tools_passes_timeout_to_stdio_client(self):
        ...
        with patch("wfx.base.mcp.util.MCPStdioClient") as mock_client_class:
    ...
    async def test_update_tools_passes_timeout_to_http_client(self):
        ...
        with patch("wfx.base.mcp.util.MCPStreamableHttpClient") as mock_client_class:
            mock_client = AsyncMock()
            mock_client.connect_to_server = AsyncMock(return_value=[])
            mock_client._connected = True
            mock_client_class.return_value = mock_client
