"""Tests for wfx.base.models.model_utils.
...
# langchain-ibm / ibm-watsonx-ai are core primeagent-base deps importable on every
...
from wfx.base.models.model_utils import fetch_live_watsonx_models, get_model_name
