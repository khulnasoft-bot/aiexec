...
import pytest
from wfx.components.xai.xai import XAIModelComponent
...
class TestXAIComponent(ComponentTestBaseWithoutClient):
    ...
    def test_build_model(self, component_class, default_kwargs, mocker):
        ...
        mock_client_kwargs = mocker.patch(
            "wfx.components.xai.xai.ssrf_protected_openai_clients_for_url",
            return_value={"http_client": http_client, "http_async_client": http_async_client},
        )
        mock_chat_openai = mocker.patch("wfx.components.xai.xai.ChatOpenAI", return_value=MagicMock())
    ...
    def test_get_models(self):
        component = XAIModelComponent()
        with patch("wfx.components.xai.xai.ssrf_safe_httpx_get") as mock_get:
    ...
    def test_build_model_error(self, component_class, mocker):
        ...
        mocker.patch(
            "wfx.components.xai.xai.ChatOpenAI",
    ...
    def test_json_mode(self, component_class, mocker):
        ...
        mocker.patch("wfx.components.xai.xai.ChatOpenAI", return_value=mock_instance)
