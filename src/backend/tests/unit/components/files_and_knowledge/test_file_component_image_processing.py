...
class TestDoclingEmptyTextExtraction:
    ...
    @patch("wfx.components.files_and_knowledge.file.get_settings_service")
    ...
    @patch("wfx.base.data.base_file.get_settings_service")
    @patch("wfx.components.files_and_knowledge.file.get_settings_service")
    @patch("subprocess.Popen")
...
class TestStoragePathResolution:
    ...
    @patch("wfx.custom.custom_component.custom_component.get_storage_service")
    @patch("wfx.base.data.base_file.get_settings_service")
...
class TestImageContentTypeValidation:
    ...
    def test_valid_png_file(self, tmp_path):
        ...
        from wfx.base.data.storage_utils import validate_image_content_type
