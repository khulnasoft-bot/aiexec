...
from wfx.components.files_and_knowledge.knowledge import (
    MODE_INGEST,
    MODE_RETRIEVE,
    KnowledgeComponent,
    _is_retrieve_mode,
...
class TestModeDrivenInputVisibility:
    ...
    def _skip_astra_gate(self):
        ...
        """
        with patch("wfx.components.files_and_knowledge.knowledge.raise_error_if_astra_cloud_disable_component") as gate:
...
class TestLegacySubclassesPinMode:
    ...
    def test_retrieval_module_reexports_filter_helpers(self) -> None:
        ...
        """
        from wfx.components.files_and_knowledge.retrieval import (
