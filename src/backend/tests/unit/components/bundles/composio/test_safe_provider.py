...
from wfx.base.composio.safe_provider import SafeLangchainProvider, _sanitize_schema  # noqa: E402
...
class TestSafeLangchainProviderRegression:
    ...
    def test_file_helper_methods_patched(self):
        ...
        assert getattr(FileHelper, "_wfx_safe_patched", False) is True
    ...
    def test_pydantic_builder_patched(self):
        ...
        assert getattr(composio_shared, "_wfx_safe_patched", False) is True
