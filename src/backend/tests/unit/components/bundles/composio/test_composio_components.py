...
from wfx.components.composio.outlook_composio import ComposioOutlookAPIComponent
...
class TestExecuteActionRichTypeCoercion:
    ...
    When a ChatInput node is wired to a str field (e.g. subject, body), Primeagent
