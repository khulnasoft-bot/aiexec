...
from wfx.components.agentics.constants import (
    PROVIDER_ANTHROPIC,
    PROVIDER_OLLAMA,
    PROVIDER_OPENAI,
)
...
class TestPrepareLlmFromComponent:
    ...
    @patch("wfx.components.agentics.helpers.llm_setup.create_llm")
    @patch("wfx.components.agentics.helpers.llm_setup.get_api_key_for_provider")
    @patch("wfx.components.agentics.helpers.llm_setup.validate_model_selection")
    def test_should_call_validate_model_selection_with_component_model(
        ...
        from wfx.components.agentics.helpers.llm_setup import prepare_llm_from_component
