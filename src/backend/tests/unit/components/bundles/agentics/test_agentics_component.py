...
from wfx.components.agentics import SemanticAggregator, SemanticMap, SyntheticDataGenerator
from wfx.components.agentics.constants import (
    TRANSDUCTION_AMAP,
    TRANSDUCTION_AREDUCE,
    TRANSDUCTION_GENERATE,
)
from wfx.components.agentics.inputs.common_inputs import GENERATED_FIELDS_TABLE_SCHEMA
