...
import pandas as pd
import pytest
from wfx.components.files_ingestion.file_description_generator import FileDescriptionGeneratorComponent
...
class TestFileDescriptionGeneratorComponent(ComponentTestBaseWithoutClient):
    ...
    def test_generate_descriptions_basic_success(self, component_class, default_kwargs):
        ...
        with patch("wfx.base.data.docling_utils._serialize_pydantic_model") as mock_serialize:
