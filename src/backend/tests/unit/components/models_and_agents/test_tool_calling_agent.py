...
class TestToolCallingAgentUpdateBuildConfig:
    ...
    @patch("wfx.components.langchain_utilities.tool_calling.get_language_model_options")
...
class TestToolCallingAgentBackwardCompatStreaming:
    ...
    def test_should_force_streaming_true_when_legacy_serialized_agent_returns_non_streaming_llm(self):
        ...
        with (
            ...
            patch(
                "wfx.components.langchain_utilities.tool_calling.create_tool_calling_agent",
    ...
    def test_should_force_streaming_true_on_granite_path(self):
        ...
        with (
            ...
            patch(
                "wfx.components.langchain_utilities.tool_calling.create_granite_agent",
                side_effect=_capture_granite,
            ),
            patch(
                "wfx.components.langchain_utilities.tool_calling.is_granite_model",
                return_value=True,
            ),
        ):
            component.create_agent_runnable()
