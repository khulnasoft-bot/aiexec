...
class TestToolCallingAgentIntegration:
    ...
    def test_watsonx_detection_in_create_agent_runnable(self):
        ...
        with (
            ...
            patch("wfx.components.langchain_utilities.tool_calling.create_granite_agent") as mock_create,
        ):
    ...
    def test_watsonx_llama_uses_default_agent(self):
        ...
        with (
            patch.object(component, "_get_llm", return_value=mock_llm),
            patch("wfx.components.langchain_utilities.tool_calling.create_tool_calling_agent") as mock_default,
        ):
    ...
    def test_non_watsonx_uses_default_agent(self):
        ...
        with (
            patch.object(component, "_get_llm", return_value=mock_llm),
            patch("wfx.components.langchain_utilities.tool_calling.create_tool_calling_agent") as mock_create,
        ):
            mock_create.return_value = Mock()
