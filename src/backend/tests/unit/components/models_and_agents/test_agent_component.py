...
class TestAgentComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("wfx.base.models.unified_models.get_language_model_options")
    ...
    @patch("wfx.components.models_and_agents.agent.get_language_model_options")
    ...
    async def test_should_force_stream_true_to_get_llm_even_when_toggle_is_false(
        ...
        chat model is built with ``streaming=True``. Mirror of the wfx-side test
    ...
    async def test_should_register_calculator_tool_only_once_when_external_calculator_connected_and_toggle_enabled(
        ...
        from wfx.components.utilities.calculator_core import CalculatorComponent
    ...
    async def test_should_accept_add_calculator_tool_in_default_keys(self, component_class, default_kwargs):
        ...
        with patch("wfx.components.models_and_agents.agent.get_language_model_options") as mock_opts:
