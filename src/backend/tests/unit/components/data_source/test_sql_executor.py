...
import pytest
from wfx.components.data_source.sql_executor import SQL_DATABASE_ENGINE_ARGS, SQLComponent
from wfx.schema import DataFrame, Message
...
class TestSQLComponent(ComponentTestBaseWithoutClient):
    ...
    def test_maybe_create_db_reuses_cached_database(self, component_class: type[SQLComponent], default_kwargs):
        ...
        with patch("wfx.components.data_source.sql_executor.SQLDatabase.from_uri") as mock_from_uri:
    ...
    def test_maybe_create_db_enables_pool_pre_ping(self, component_class: type[SQLComponent], default_kwargs):
        ...
        with patch(
            "wfx.components.data_source.sql_executor.SQLDatabase.from_uri",
