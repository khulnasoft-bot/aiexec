...
from wfx.interface.components import _warm_circular_imports
...
class TestAllModulesImportable:
    ...
    def test_all_components_in_categories_importable(self):
        ...
        # NOTE: ibm.* moved to the wfx-ibm bundle (src/bundles/ibm) and is no
        # longer iterated through ``primeagent.components``; the watsonx
