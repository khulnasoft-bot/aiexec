"""Tests for flow validation utilities (wfx.utils.flow_validation).
...
class TestBuildCodeHashLookups:
    """Tests for _build_code_hash_lookups in wfx.interface.components."""

    def test_populates_hash_lookups_from_all_types_dict(self):
        from wfx.interface.components import ComponentCache, _build_code_hash_lookups
