...
so it is excluded from Python 3.14+ environments such as the official Primeagent Docker images.
...
import pytest
from primeagent.services.tracing import langwatch as langwatch_module
