"""Unit tests for primeagent.services.tracing.formatting.
...
from primeagent.services.database.models.traces.model import SpanStatus, SpanTable, SpanType
from primeagent.services.tracing.formatting import (
...
class TestExtractTraceIoFromSpans:
    ...
    def test_should_match_chat_input_span_by_substring(self):
        ...
        span = _span(
            name=f"Primeagent {_CHAT_INPUT_SPAN_NAME} Component",
