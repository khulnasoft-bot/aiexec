...
import pytest
from primeagent.memory import aadd_messages, aget_messages, astore_message
...
def sample_session_metadata():
    ...
    return {
        ...
        "custom_fields": {"department": "engineering", "project": "primeagent"},
    }
...
async def test_messageupdate_with_session_metadata(sample_session_metadata):
    ...
    from primeagent.services.database.models.message.model import MessageUpdate
