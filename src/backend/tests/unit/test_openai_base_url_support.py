...
base url to openai for primeagent assistant." Verified live (2026-06-12):
...
from wfx.base.models.model_metadata import (
    CONDITIONAL_LIVE_MODEL_PROVIDERS,
    LIVE_MODEL_PROVIDERS,
)
from wfx.base.models.model_utils import (
...
class TestGetLlmBaseUrl:
    def test_should_pass_base_url_to_chat_openai_when_variable_is_set(self):
        with patch(
            "wfx.base.models.unified_models.get_all_variables_for_provider",
...
class TestLiveOpenAICompatibleModels:
    def test_should_return_empty_when_no_base_url_is_configured(self):
        with patch(
            "wfx.base.models.model_utils.get_provider_variable_value",
            return_value=None,
        ):
...
class TestConditionalLiveReplacement:
    ...
    def test_should_keep_static_catalog_when_openai_live_fetch_is_empty(self):
        ...
        with patch(
            "wfx.base.models.model_utils.get_live_models_for_provider",
            return_value=[],
        ):
...
class TestBaseUrlNormalizationParity:
    ...
    def test_validation_normalizes_base_url_like_runtime(self):
        ...
        with (
            ...
            patch("wfx.utils.util.transform_localhost_url", return_value=self.TRANSFORMED),
        ):
            validate_model_provider_key(
                "OpenAI",
