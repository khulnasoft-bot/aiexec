...
async def test_update_project_file_success():
    ...
    from primeagent.initial_setup.setup import update_project_file
...
async def test_update_project_file_permission_denied():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with patch("primeagent.initial_setup.setup.aiofiles.open") as mock_open:
...
async def test_update_project_file_logs_debug_on_oserror():
    ...
    with patch("primeagent.initial_setup.setup.logger") as mock_logger:
