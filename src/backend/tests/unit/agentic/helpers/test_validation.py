...
import pytest
from primeagent.agentic.helpers.validation import (
...
MODULE = "primeagent.agentic.helpers.validation"
...
class TestValidateComponentCode:
    ...
    def test_should_not_execute_code_during_validation(self):
        ...
        """
        env_key = "_PRIMEAGENT_SECURITY_VALIDATION_TEST"
...
class TestValidateComponentRuntimeExecution:
    ...
    async def test_should_accept_valid_component_with_dict_input(self):
        ...
        good_code = dedent(
            """
            from wfx.custom import Component
            from wfx.io import DictInput, Output
            from wfx.schema.data import Data
