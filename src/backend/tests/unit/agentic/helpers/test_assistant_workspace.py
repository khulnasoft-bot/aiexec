...
- Env var name (PRIMEAGENT_FS_TOOL_BASE_DIR) and default path (~/.primeagent/fs_tool/fs_sandbox)
...
import pytest
from primeagent.agentic.helpers.assistant_workspace import (
    BASE_DIR_ENV,
...
class TestResolveAssistantFsRoot:
    ...
    env var (expanded, stripped) → ~/.primeagent/fs_tool/fs_sandbox default.
