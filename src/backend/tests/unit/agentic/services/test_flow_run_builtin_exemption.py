...
catch LLM-generated component code, but it was also flagging *built-in* Primeagent
...
from primeagent.agentic.services.flow_run import _scan_flow_component_code
...
# Built-in URLComponent uses importlib.util.find_spec for optional primeagent
...
class TestBuiltinExemption:
    def test_should_pass_when_node_code_is_byte_identical_to_canonical(self):
        ...
        with patch(
            "wfx.mcp.flow_builder_tools._state._load_registry_user_aware",
