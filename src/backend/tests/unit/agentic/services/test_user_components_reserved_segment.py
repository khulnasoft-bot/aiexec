...
# The wfx tests are blocked from the main venv by the package-isolation
...
def _make_component(
    ...
    *,
    ...
    The component bypasses the PrimeagentClient by binding ``_user_id``
    ...
    monkeypatch.setenv("PRIMEAGENT_FS_TOOL_BASE_DIR", str(base_dir))
