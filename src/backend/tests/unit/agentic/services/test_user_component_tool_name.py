...
``src/wfx/tests/unit/custom/component/test_tool_name_fallback.py``;
...
from primeagent.agentic.services.user_components_overlay import load_registry_with_user_overlay
