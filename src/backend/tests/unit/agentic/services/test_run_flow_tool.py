...
Lives in wfx.mcp.flow_builder_tools but is exercised here (backend tree)
because it lazily imports primeagent.agentic.services.flow_run, which the
isolated wfx suite cannot resolve.
"""
...
RWF = "primeagent.agentic.services.flow_run.run_working_flow"
...
class TestRunFlowInjectsVerifiedModel:
    ...
    def teardown_method(self):
        from primeagent.agentic.services.agent_run_context import reset_agent_run_model
    ...
    def test_injects_the_assistants_verified_model_into_modelless_agent_before_running(self):
        from primeagent.agentic.services.agent_run_context import set_agent_run_model
