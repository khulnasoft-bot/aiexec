...
class TestStepTypeIncludesGeneratingDocument:
    ...
    def test_step_type_should_include_generating_document(self):
        ...
        from primeagent.agentic.api.schemas import StepType
...
class TestStreamingEmitsFileWrittenEvents:
    ...
    async def test_stream_should_yield_file_written_when_file_events_pending(self, monkeypatch):
        ...
        """  # noqa: D205
        from primeagent.agentic.services import assistant_service
        from primeagent.agentic.services.file_events import emit_file_event, reset_file_events
        ...
        async def fake_classify_intent(*args, **kwargs):  # noqa: ARG001
            from primeagent.agentic.services.flow_types import IntentResult
        ...
        sse_lines: list[str] = [
            ...
            async for line in assistant_service.execute_flow_with_validation_streaming(
                flow_filename="PrimeagentAssistant.json",  # default; overridden internally by intent
