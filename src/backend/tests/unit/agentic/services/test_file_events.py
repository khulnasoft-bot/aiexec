...
Pattern mirrors `wfx.mcp.flow_builder_tools._flow_events_var` but with a fresh
...
import pytest
from primeagent.agentic.services.file_events import (
    drain_file_events,
    emit_file_event,
    reset_file_events,
...
class TestContextIsolation:
    ...
    def test_file_events_should_be_shared_across_asyncio_tasks_within_same_request(self):
        ...
        ``wfx.mcp.flow_builder_tools._flow_events_var``: reset allocates a
