...
from wfx.utils.flow_validation import CustomComponentValidationError

MODULE = "primeagent.agentic.services.flow_executor"
...
class TestExecuteFlowFileStreamingEvents:
    ...
    async def test_should_carry_original_error_internally_without_leaking_in_http_detail(self):
        ...
        """
        from primeagent.agentic.services.flow_types import FlowExecutionError
