...
pattern: one agent, many tools). Lives in wfx.mcp.flow_builder_tools but
exercised here because it lazily imports primeagent.agentic.services.
"""
...
from wfx.mcp.flow_builder_tools import GenerateComponent

EFV = "primeagent.agentic.services.assistant_service.execute_flow_with_validation"
...
class TestGenerateComponentTool:
    ...
    def test_passes_request_provider_model_and_user_from_context(self):
        from primeagent.agentic.services.agent_run_context import reset_agent_run_model, set_agent_run_model
