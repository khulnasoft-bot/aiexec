...
import pytest
from wfx.mcp.tool_cache import (
    MAX_CACHE_ENTRIES,
    cached_tool_call,
    reset_tool_cache,
)
...
class TestFlowBuilderToolsIntegration:
    ...
    def test_search_components_should_use_request_cache(self):
        from wfx.mcp.flow_builder_tools import SearchComponentTypes
        ...
        import wfx.mcp.flow_builder_tools.read_tools as fbt  # B2: patch the resolution site
    ...
    def test_describe_component_should_use_request_cache(self):
        from wfx.mcp.flow_builder_tools import DescribeComponentType
