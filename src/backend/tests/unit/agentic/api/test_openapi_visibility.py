...
(authenticated, documented in ``docs/features/primeagent-assistant.md``,
...
from primeagent.agentic.api.files_router import router as files_router
from primeagent.agentic.api.router import router as assistant_router
