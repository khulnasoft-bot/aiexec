...
and validating that the code is a valid Primeagent component.
"""

from primeagent.agentic.helpers.code_extraction import (
    _find_code_blocks,
...
INCOMPLETE_COMPONENT_CODE = """from primeagent.custom import Component
from primeagent.io import MessageTextInput, Output
...
# Invalid syntax code
INVALID_SYNTAX_CODE = """from primeagent.custom import Component
...
class TestExtractPythonCode:
    ...
    def test_extract_from_closed_python_block(self):
        ...
        assert "from primeagent.custom import Component" in result
...
```"""
    ...
    def test_handles_code_with_special_characters(self):
        ...
        code_with_specials = """from primeagent.custom import Component
...
class TestValidateComponentCode:
    ...
    def test_validates_valid_component(self):
        """Should validate correct Primeagent component code."""
    ...
    def test_fails_for_non_component_code(self):
        """Should fail validation for code that's not a Primeagent component."""
...
Based on your request, I'll create a custom Primeagent component that performs sentiment analysis.
This component will:
1. Take text input
...
class TestEdgeCases:
    ...
    def test_handles_unicode_in_code(self):
        ...
        unicode_code = """from primeagent.custom import Component
