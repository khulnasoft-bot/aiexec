"""Tests for migrate_orphaned_mcp_servers_config in primeagent.services.utils.
...
from primeagent.services.utils import migrate_orphaned_mcp_servers_config
...
async def initialized_services(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("PRIMEAGENT_CONFIG_DIR", str(config_dir))
