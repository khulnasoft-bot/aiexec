...
def test_shape_config_list_result_pagination() -> None:
    from wfx.services.adapters.deployment.schema import ConfigListItem, ConfigListResult
...
def test_shape_config_list_result_empty() -> None:
    from wfx.services.adapters.deployment.schema import ConfigListResult
