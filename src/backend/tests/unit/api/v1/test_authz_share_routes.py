...
from primeagent.api.v1 import authz_shares as shares_module
from primeagent.api.v1.schemas.authz_shares import ShareCreate, ShareUpdate
from primeagent.services.database.models.auth import AuthzShare, SharePermissionLevel, ShareScope
...
def patch_authz(monkeypatch):
    ...
    from primeagent.services.authorization import audit as authz_audit
    from primeagent.services.authorization import guards as authz_guards
    from primeagent.services.authorization import listing as authz_listing
