...
from primeagent.api.v1.deployments import DeploymentTelemetryCtx
from primeagent.api.v1.mappers.deployments.contracts import ProviderSnapshotBinding
from primeagent.api.v1.mappers.deployments.watsonx_orchestrate import WatsonxOrchestrateDeploymentMapper
from primeagent.api.v1.schemas.deployments import (
...
from primeagent.services.database.models.deployment.exceptions import DeploymentGuardError
from primeagent.services.database.models.deployment_provider_account.schemas import DeploymentProviderKey
...
ROUTES_MODULE = "primeagent.api.v1.deployments"
HELPERS_MODULE = "primeagent.api.v1.mappers.deployments.helpers"
...
class TestCreateDeploymentRollback:
    ...
    async def test_rollback_called_on_commit_failure(
        ...
        from primeagent.api.v1.deployments import create_deployment
...
class TestListDeploymentsLoadFromProvider:
    ...
    async def test_load_from_provider_bypasses_db_view(
        ...
        from primeagent.api.v1.deployments import list_deployments
...
class TestListDeploymentsMetadataSync:
    ...
    async def test_provider_description_passed_and_display_name_stays_in_provider_data(
        ...
        def _apply_metadata_batch(*_args, **kwargs):
            ...
            update.primeagent_db_row.display_name = update.display_name
            update.primeagent_db_row.description = update.description
...
class TestConfigAndSnapshotListRoutes:
    ...
    async def test_list_configs_global_scope_uses_provider_id(
        ...
        from primeagent.api.v1.deployments import list_deployment_configs
    ...
    async def test_list_snapshots_deployment_scope_resolves_provider_from_deployment(
        ...
        from primeagent.api.v1.deployments import list_deployment_snapshots
...
class TestUpdateSnapshotRoute:
    @pytest.mark.asyncio
    @patch("primeagent.services.database.models.flow_version.crud.get_flow_version_entry", new_callable=AsyncMock)
    @patch("primeagent.services.database.models.deployment.crud.get_deployment", new_callable=AsyncMock)
    ...
    async def test_updates_all_attachment_rows_for_snapshot(
        ...
        from primeagent.api.v1.deployments import update_snapshot
...
class TestListDeploymentFlowVersionsRoute:
    ...
    async def test_returns_paginated_flow_versions(
        ...
        from primeagent.api.v1.deployments import list_deployment_flow_versions
...
class TestProviderAccountRoutes:
    ...
    async def test_update_provider_account_name_only_skips_credential_verification(
        ...
        from primeagent.api.v1.deployments import update_provider_account
    ...
    async def test_create_provider_account_conflict_returns_409(
        ...
        from primeagent.api.v1.deployments import create_provider_account
    ...
    async def test_delete_provider_account_rejects_when_deployments_exist(
        ...
        from primeagent.api.v1.deployments import delete_provider_account
    ...
    async def test_delete_provider_account_sets_deployment_provider_scope_for_reconciliation(
        ...
        """
        from primeagent.api.v1.deployments import delete_provider_account
        from primeagent.services.adapters.deployment.context import DeploymentProviderIDContext
...
class TestUpdateDeploymentRollback:
    ...
    async def test_rollback_called_on_commit_failure(
        ...
        from primeagent.api.v1.deployments import update_deployment
...
class TestGetDeploymentSync:
    ...
    async def test_stale_row_deleted_when_provider_returns_not_found(
        ...
        from primeagent.api.v1.deployments import get_deployment
        from primeagent.api.v1.mappers.deployments.base import BaseDeploymentMapper
...
class TestDeleteDeployment:
    ...
    async def test_provider_not_found_still_deletes_local_row(
        ...
        from primeagent.api.v1.deployments import delete_deployment
...
class TestListDeploymentLlms:
    ...
    async def test_list_llms_returns_shaped_response(
        ...
        from primeagent.api.v1.deployments import list_deployment_llms
...
class TestResolveDeploymentAdapter:
    def test_empty_provider_key_raises_400(self):
        from primeagent.api.v1.mappers.deployments.helpers import resolve_deployment_adapter
...
class TestHandleAdapterErrors:
    def test_maps_authentication_error_to_401(self):
        from primeagent.api.v1.mappers.deployments.helpers import handle_adapter_errors
