...
def enable_rate_limiting(monkeypatch):
    ...
    monkeypatch.setenv("PRIMEAGENT_RATE_LIMIT_ENABLED", "true")


@pytest.fixture
def limiter_snapshot():
    """Fixture to snapshot and restore the global limiter singleton."""
    import primeagent.services.rate_limit.service as rate_limit_module
...
class TestRateLimitService:
    ...
    def test_rate_limit_string_default(self, enable_rate_limiting):  # noqa: ARG002
        ...
        from primeagent.services.rate_limit.service import get_rate_limit_string
    ...
    def test_rate_limiter_uses_client_ip_when_trust_proxy_enabled(
        ...
        from primeagent.services.rate_limit.service import get_client_ip
        ...
        monkeypatch.setattr(
            "primeagent.services.rate_limit.service.get_settings_service", lambda: mock_settings_service
        )
...
class TestRateLimitIntegration:
    ...
    async def test_login_endpoint_has_rate_limiter_applied(self, enable_rate_limiting):  # noqa: ARG002
        ...
        from primeagent.api.v1.login import get_limiter_from_app, login_to_get_access_token
        from primeagent.main import create_app
