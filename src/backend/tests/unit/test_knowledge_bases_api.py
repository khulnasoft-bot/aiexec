...
class TestKnowledgeBaseAPI:
    ...
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.teardown_storage")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("primeagent.api.v1.knowledge_bases.Chroma")
...
class TestPerformIngestionTask:
    ...
    @patch("primeagent.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
