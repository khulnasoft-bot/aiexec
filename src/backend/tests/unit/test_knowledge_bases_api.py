...
from primeagent.api.utils import knowledge_base_service
from primeagent.api.utils.kb_helpers import (
    KBAnalysisHelper,
    KBIngestionHelper,
    KBStorageHelper,
)
...
class TestGetKBMetaData:
    ...
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    ...
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_provider")
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_model")
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
...
class TestKnowledgeBaseAPI:
    ...
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.v1.knowledge_bases.logger.warning")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.v1.knowledge_bases.knowledge_base_service.backfill_from_disk", new_callable=AsyncMock)
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.v1.knowledge_bases.knowledge_base_service.create_record", new_callable=AsyncMock)
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.delete_storage", return_value=True)
    @patch("primeagent.api.v1.knowledge_bases.create_backend")
    @patch("primeagent.api.v1.knowledge_bases.knowledge_base_service.delete_by_user_and_name", new_callable=AsyncMock)
    @patch("primeagent.api.v1.knowledge_bases.knowledge_base_service.get_by_user_and_name", new_callable=AsyncMock)
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    async def test_delete_knowledge_base_cancels_inflight_ingestion(
        ...
        """
        from primeagent.services.database.models.jobs.model import JobStatus, JobType
        from primeagent.services.deps import get_job_service
    ...
    @patch("primeagent.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.delete_storage", return_value=True)
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.v1.knowledge_bases.logger")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("primeagent.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("primeagent.api.v1.knowledge_bases.get_job_service")
    @patch("primeagent.api.v1.knowledge_bases.get_task_service")
    ...
    async def test_get_chunks_pagination_and_search(
        ...
        Astra / Postgres.
        """
        from wfx.base.knowledge_bases.backends.base import IngestedDocument
    ...
    async def test_get_metadata_keys_caps_distinct_values_per_key(
        ...
        from primeagent.api.v1.knowledge_bases import KB_METADATA_KEYS_VALUES_CAP
        from wfx.base.knowledge_bases.backends.base import IngestedDocument
...
class TestPerformIngestionTask:
    ...
    @patch("primeagent.api.utils.ingestion_run_service.finalize_run", new_callable=AsyncMock)
    @patch("primeagent.api.utils.ingestion_run_service.mark_running", new_callable=AsyncMock)
    @patch("primeagent.api.utils.ingestion_run_service.create_run", new_callable=AsyncMock)
    @patch("primeagent.api.utils.kb_helpers.create_backend")
    @patch("primeagent.api.utils.kb_helpers.KBIngestionHelper.build_embeddings", new_callable=AsyncMock)
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper.get_metadata")
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    async def test_perform_ingestion_success(
        ...
        from wfx.base.knowledge_bases.ingestion_sources.base import IngestionRunStatus
    ...
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper.get_metadata")
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics_via_backend", new_callable=AsyncMock)
    ...
    @patch("primeagent.api.utils.ingestion_run_service.mark_running", new_callable=AsyncMock)
    @patch("primeagent.api.utils.ingestion_run_service.create_run", new_callable=AsyncMock)
    @patch("primeagent.api.utils.knowledge_base_service.get_by_user_and_name", new_callable=AsyncMock)
    @patch("primeagent.api.utils.kb_helpers.create_backend")
    @patch("primeagent.api.utils.kb_helpers.KBIngestionHelper.build_embeddings", new_callable=AsyncMock)
    @patch("primeagent.api.utils.kb_helpers.KBAnalysisHelper.get_metadata")
    @patch("primeagent.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    ...
    @patch("primeagent.api.utils.kb_helpers.create_backend")
    @patch("primeagent.api.utils.kb_helpers.KBIngestionHelper.build_embeddings", new_callable=AsyncMock)
    @patch("primeagent.api.utils.kb_helpers.KBIngestionHelper.cleanup_chroma_chunks_by_job", new_callable=AsyncMock)
...
class TestCancelIngestion:
    ...
    @patch("primeagent.api.v1.knowledge_bases.KBIngestionHelper.cleanup_chroma_chunks_by_job")
    @patch("primeagent.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("primeagent.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    async def test_cancel_ingestion_success(
        ...
        with mock_patch("primeagent.services.deps.get_service", side_effect=get_service_side_effect):
            response = await client.post(
