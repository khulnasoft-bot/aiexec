...
import pytest
from primeagent.api.utils.flow_utils import cascade_delete_flow
from primeagent.services.database.models.deployment.crud import list_deployments_page
from primeagent.services.database.models.deployment.guards import (
...
from primeagent.services.database.models.flow_version.crud import (
...
class TestVersionPruningRespectsLiveDeployments:
    async def test_orphan_attachment_does_not_pin_version_during_pruning(
        ...
        with patch(
            "primeagent.services.database.models.flow_version.crud.get_settings_service",
