...
DEPLOYMENT_CLASS = "primeagent.services.database.models.deployment.crud.Deployment"
...
async def test_create_deployment_integrity_error_raises_value_error():
    ...
    with (
        ...
        patch("primeagent.services.database.models.deployment.crud.logger") as mock_logger,
    ):
