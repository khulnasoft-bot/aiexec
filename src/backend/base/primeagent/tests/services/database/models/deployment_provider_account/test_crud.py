...
_ENCRYPT_TARGET = "primeagent.services.database.models.deployment_provider_account.crud.auth_utils"
_CRUD_LOGGER = "primeagent.services.database.models.deployment_provider_account.crud.logger"
