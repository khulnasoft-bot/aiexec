...
async def _update_existing_tools(
    *,
    ...
    for tool_id in rename_tool_ids:
        ...
        writable_tool["name"] = build_primeagent_wxo_resource_name(tool_display_name, resource="Tool")
...
def build_update_payload_from_spec(
    ...
    *,
    ...
    if "display_name" in update_payload and "name" not in update_payload:
        update_payload["name"] = build_primeagent_wxo_resource_name(update_payload["display_name"], resource="Agent")
