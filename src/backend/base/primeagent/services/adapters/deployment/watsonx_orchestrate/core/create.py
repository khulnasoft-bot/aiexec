...
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.shared import (
...
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    ensure_primeagent_connections_binding,
    to_writable_tool_payload,
    verify_primeagent_owned,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.payloads import (
    ...
    build_primeagent_wxo_resource_name,
...
if TYPE_CHECKING:
    ...
    from wfx.services.adapters.deployment.payloads import DeploymentPayloadSchemas
...
def build_provider_create_plan(
    *,
    ...
    technical_deployment_name = (
        ...
        else build_primeagent_wxo_resource_name(provider_create.display_name, resource="Agent")
    )
