...
from wfx.services.adapters.deployment.base import BaseDeploymentService
...
from wfx.services.adapters.payload import AdapterPayloadMissingError, AdapterPayloadValidationError

from primeagent.services.adapters.deployment.watsonx_orchestrate.client import get_authenticator, get_provider_clients
from primeagent.services.adapters.deployment.watsonx_orchestrate.constants import (
    SUPPORTED_ADAPTER_DEPLOYMENT_TYPES,
    ErrorPrefix,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.config import (
    list_configs as list_adapter_configs,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.create import (
    apply_provider_create_plan_with_rollback,
    build_provider_create_plan,
    validate_provider_create_request_sections,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.execution import (
    create_agent_run,
    get_agent_run,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.models import (
    fetch_models_adapter,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.retry import (
    retry_update,
    rollback_created_resources,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.status import (
...
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.tools import (
    ...
    extract_primeagent_connections_binding,
    upload_tool_artifact_bytes,
    verify_tools_by_ids,
)
from primeagent.services.adapters.deployment.watsonx_orchestrate.core.update import (
...
class WatsonxOrchestrateDeploymentService(BaseDeploymentService):
    ...
    async def update_snapshot(
        ...
        *,
        ...
        Primeagent flow name. This is intentional: the user may have set a
        ...
        * **Tool renamed in wxO console** — The new name is picked up
          ...
          Primeagent never stores the tool name locally.
        ...
        **Blast-radius boundary:** callers must verify that ``snapshot_id``
        is tracked by a Primeagent attachment record before calling this
        ...
        # been deployed with a custom name that differs from the Primeagent flow
