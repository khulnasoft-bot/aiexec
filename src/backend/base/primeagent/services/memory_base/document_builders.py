...
from primeagent.api.utils.kb_helpers import KBAnalysisHelper, KBStorageHelper, chunk_text_for_ingestion
...
def sync_kb_metadata(*, kb_path: Path, chroma: Chroma) -> None:
    ...
    try:
        ...
        # The wfx logger's sync .warning() method goes through the same structured pipeline.
