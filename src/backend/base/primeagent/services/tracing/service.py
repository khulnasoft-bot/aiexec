...
def _get_openlayer_tracer():
    from primeagent.services.tracing.openlayer import OpenlayerTracer
...
class TraceContext:
    def __init__(
        ...
        # ``user_id`` is the authenticated Primeagent user (e.g. API-key owner)
...
class TracingService(Service):
    ...
    def _initialize_langfuse_tracer(self, trace_context: TraceContext) -> None:
        ...
        # ``user_id`` carries the authenticated Primeagent user and drives
