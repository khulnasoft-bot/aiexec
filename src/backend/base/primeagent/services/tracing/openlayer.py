...
class OpenlayerTracer(BaseTracer):
    ...
    def add_trace(
        ...
        # Map PrimeAgent trace_type to Openlayer StepType
    ...
    def _convert_to_openlayer_type(self, value: Any) -> Any:
        """Convert PrimeAgent/LangChain types to Openlayer-compatible primitives.
    ...
    def _get_config(trace_name: str | None = None) -> dict:
        ...
        2. JSON mapping: OPENLAYER_PRIMEAGENT_MAPPING
        ...
        if not inference_pipeline_id:
            mapping_json = os.getenv("OPENLAYER_PRIMEAGENT_MAPPING")
