...
from wfx.services.authorization.base import BaseAuthorizationService  # noqa: TC002
...
def get_authorization_service() -> BaseAuthorizationService:
    ...
    from primeagent.services.authorization.factory import AuthorizationServiceFactory
...
def get_flow_events_service():
    from primeagent.services.flow_events.factory import FlowEventsServiceFactory
...
def get_memory_base_service():
    ...
    from primeagent.services.memory_base.factory import MemoryBaseServiceFactory

    return get_service(ServiceType.MEMORY_BASE_SERVICE, MemoryBaseServiceFactory())


def get_telemetry_writer_service():
    """Return the TelemetryWriterService instance (always registered when primeagent is installed)."""
    from primeagent.services.telemetry_writer.factory import TelemetryWriterServiceFactory
