...
* ``primeagent.services.authorization.audit``   — batched audit pipeline
* ``primeagent.services.authorization.guards``  — ``ensure_*_permission`` family
* ``primeagent.services.authorization.listing`` — ``filter_visible_resources``

This module is preserved so existing imports
(``from primeagent.services.authorization.utils import ensure_flow_permission``)
...
from primeagent.services.authorization.listing import (
    _default_resource_id_getter,
    filter_visible_resources,
)
from primeagent.services.deps import get_authorization_service, get_settings_service
