...
from primeagent.services.variable.constants import GENERIC_TYPE
...
async def update_enabled_models(
    *,
    ...
    for update in updates:
        if update.enabled:
            from wfx.base.models.unified_models import get_all_variables_for_provider, validate_model_provider_key
