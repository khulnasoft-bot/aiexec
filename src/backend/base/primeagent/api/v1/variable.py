...
from primeagent.api.v1.schemas.deployments import DetectVarsRequest, DetectVarsResponse
from primeagent.services.authorization import VariableAction, ensure_variable_permission
