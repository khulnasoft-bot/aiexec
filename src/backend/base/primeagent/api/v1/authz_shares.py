...
from primeagent.api.v1.schemas.authz_shares import ShareCreate, ShareRead, ShareUpdate
from primeagent.services.authorization import ShareAction, ensure_share_permission
from primeagent.services.authorization.utils import audit_decision
from primeagent.services.database.models.auth import AuthzShare, AuthzTeamMember, SharePermissionLevel, ShareScope
...
async def _ensure_can_administer_share(
    *,
    ...
    if await authz.supports_cross_user_fetch() and await authz.is_enabled():
        ...
        # PrimeagentAuthorizationService), so this early-return is dead and the
