...
from wfx.services.mcp_composer.service import (
...
async def verify_project_auth(
    ...
    # OAuth projects must present a valid API key at the Primeagent transport endpoint: network-level
    ...
    # composer-to-Primeagent hop should be authenticated explicitly once mcp-composer can forward
    ...
    try:
        async with session_scope() as session:
            ...
            if auth_settings_updated and new_auth_type in {"apikey", "none"}:
                from primeagent.api.v1.projects_mcp_helpers import reconcile_mcp_server_for_auth_update
                ...
                try:
                    ...
                    async with session.begin_nested():
                        ...
                        if should_reconcile_project_server:
                            from primeagent.api.v1.projects_mcp_helpers import register_mcp_servers_for_project
