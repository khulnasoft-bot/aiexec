...
from primeagent.services.deps import get_memory_base_service, session_scope
...
async def list_sessions(
    ...
    """
    from primeagent.services.memory_base.ingestion import count_pending_messages
