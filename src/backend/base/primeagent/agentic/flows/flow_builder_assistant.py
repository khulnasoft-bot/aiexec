"""FlowBuilderAssistant - Builds Primeagent flows using component discovery tools.
...
from primeagent.agentic.flows.model_config import build_model_config
from primeagent.agentic.services.file_events import wrap_file_tool_with_event

FLOW_BUILDER_PROMPT = """\
You are a Primeagent Flow Builder assistant. You build and modify flows directly \
