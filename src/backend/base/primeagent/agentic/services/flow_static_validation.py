...
Reuses Primeagent's existing CLI validator
(``wfx.cli.validation.core.validate_flow_file`` →
...
from wfx.cli.validation.core import LEVEL_REQUIRED_INPUTS, validate_flow_file
...
def _unknown_component_errors(flow: dict[str, Any]) -> list[str]:
    ...
    """
    try:
        from wfx.mcp.flow_builder_tools import _load_registry_user_aware
