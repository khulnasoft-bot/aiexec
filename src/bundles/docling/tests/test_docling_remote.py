...
# NOTE: Import the bundle component module before wfx.inputs/wfx.schema. Importing
# wfx.inputs/wfx.schema first leaves wfx.custom partially initialized and triggers a
# circular import when the component (a Component subclass) is imported afterwards.
# isort: off
from wfx_docling.components.docling import docling_remote
from wfx_docling.components.docling.docling_remote import DoclingRemoteComponent

from wfx.inputs import TableInput
