...
import pytest
from wfx_docling.components.docling.chunk_docling_document import (
...
class TestChunkDoclingDocumentComponentHybridChunker:
    def _run_chunk_documents_with_mocks(
        ...
        monkeypatch.setattr(
            "wfx_docling.components.docling.chunk_docling_document._load_docling_chunker_dependencies",
            lambda: (DummyDocMeta, DummyHierarchicalChunker),
        )
        monkeypatch.setattr(
            "wfx_docling.components.docling.chunk_docling_document.extract_docling_documents",
