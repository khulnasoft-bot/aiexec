...
from wfx.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, Output, StrInput
from wfx.schema import Data, DataFrame

_CHUNKING_INSTALL_HINT = (
    "Install them with `uv pip install 'wfx-docling[chunking]'`, "
    "`uv pip install 'primeagent[docling-chunking]'`, or "
