...
from wfx.base.data.docling_utils import coerce_docling_document
from wfx.inputs import IntInput, NestedDictInput, StrInput, TableInput
from wfx.inputs.inputs import FloatInput
from wfx.schema import Data, DataFrame, dotdict
