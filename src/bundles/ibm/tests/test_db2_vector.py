"""Unit tests for the DB2 Vector Store component (wfx-ibm bundle).

The component used to live at ``wfx.components.ibm.db2_vector`` and was
...
class TestDB2VectorStoreComponent:
    ...
    def test_ssl_certificate_url_download(self, component, mock_embedding):
        ...
        with (
            patch("wfx_ibm.components.ibm.db2_security.download_certificate") as mock_download,
            patch("ibm_db_dbi.connect") as mock_connect,
            patch.object(component, "_add_documents_to_vector_store"),
        ):
    ...
    def test_bulk_insert_mode_uses_executemany(self, mock_embedding):
        ...
        with (
            patch("wfx_ibm.components.ibm.db2vs._table_exists", return_value=False),
            patch("wfx_ibm.components.ibm.db2vs._create_table"),
            patch(
                "wfx_ibm.components.ibm.db2vs._get_column_names",
