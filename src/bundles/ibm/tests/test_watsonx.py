...
# langchain-ibm / ibm-watsonx-ai are real runtime deps of the wfx-ibm bundle,
...
# with a MagicMock so the wfx workspace venv (which did not pull
...
# import path, e.g. ``@patch("wfx_ibm.components.ibm.watsonx.ChatWatsonx")``.
...
class TestWatsonxAIComponent:
    ...
    @patch("wfx_ibm.components.ibm.watsonx.WatsonxAIComponent.fetch_models")
    ...
    @patch("wfx_ibm.components.ibm.watsonx.ChatWatsonx")
    ...
    @patch("wfx_ibm.components.ibm.watsonx.WatsonxAIComponent.fetch_models")
    @patch("wfx_ibm.components.ibm.watsonx.logger")
