...
class TestDB2VSHelperFunctions:
    ...
    def test_table_exists_true(self):
        ...
        from wfx_ibm.components.ibm.db2vs import _table_exists
    ...
    def test_get_distance_function_cosine(self):
        ...
        from wfx_ibm.components.ibm.db2vs import _get_distance_function
...
class TestDB2VSClass:
    ...
    @patch("wfx_ibm.components.ibm.db2vs._table_exists")
    @patch("wfx_ibm.components.ibm.db2vs._create_table")
    @patch("wfx_ibm.components.ibm.db2vs._get_column_names")
    @patch("wfx_ibm.components.ibm.db2vs.DB2VS.get_embedding_dimension")
    def test_db2vs_initialization_new_table(
        ...
        from langchain_community.vectorstores.utils import DistanceStrategy
        from wfx_ibm.components.ibm.db2vs import DB2VS
    ...
    @patch("wfx_ibm.components.ibm.db2vs._table_exists")
    @patch("wfx_ibm.components.ibm.db2vs._get_column_names")
    @patch("wfx_ibm.components.ibm.db2vs._update_empty_embeddings")
    @patch("wfx_ibm.components.ibm.db2vs._create_table")
    @patch("wfx_ibm.components.ibm.db2vs.DB2VS.get_embedding_dimension")
    ...
    @patch("wfx_ibm.components.ibm.db2vs._create_table")
    @patch("wfx_ibm.components.ibm.db2vs.DB2VS.get_embedding_dimension")
    @patch("wfx_ibm.components.ibm.db2vs.DB2VS._validate_embedding_dimension")
    def test_add_texts(
        self,
    ...
    def test_drop_table(self):
        ...
        from wfx_ibm.components.ibm.db2vs import drop_table
