...
from wfx.base.models.model_utils import get_watsonx_llm_models
...
class WatsonxAIComponent(LCModelComponent):
    """WFX component for IBM watsonx.ai text/chat generation."""
    ...
    # bundle's static AST validator (``wfx extension validate``) detects
