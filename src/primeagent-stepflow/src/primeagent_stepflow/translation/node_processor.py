"""Process individual Primeagent nodes into Stepflow steps."""
...
class NodeProcessor:
    """Processes individual Primeagent nodes into Stepflow steps."""
    ...
    def process_node(
        ...
        """Process a Primeagent node using flow builder architecture.
    ...
    def _generate_step_id(self, node_id: str, component_type: str) -> str:
        ...
        Args:
            node_id: Original Primeagent node ID
        ...
        # Always use primeagent prefix with the full base_id to guarantee uniqueness
        return f"primeagent_{base_id}"
    ...
    def _add_variable(self, name: str, type: str) -> Value:
        ...
        input_type = self.schema_mapper.primeagent_to_json_schema[type]
    ...
    def _extract_runtime_inputs_for_builder(
        ...
        if not dependency_node_ids and component_type == "File":
            ...
            # Path parameter should match Primeagent's FileInput expectations
    ...
    def _create_tool_component_step(
        ...
        try:
            ...
            step_handle = builder.add_step(
                id=step_id,
                component="/primeagent/component_tool",
                input_data={
