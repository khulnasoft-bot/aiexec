"""Hash-to-module mappings for known Primeagent core components.

This module contains mappings of code hashes to component module paths for
known Primeagent core components. When a component's code_hash matches an entry
here and the module matches, we can use the core executor instead of compiling
custom code from a blob.

The hashes are derived from the Primeagent workflow metadata and can be found in
...
class KnownComponent:
    ...
    code_hash: str
    module: str  # Full module path, e.g., "wfx_docling.components.docling.DoclingInlineComponent"
    description: str = ""
...
# These hashes are version-specific and may need updating when Primeagent versions change
KNOWN_COMPONENTS: dict[str, KnownComponent] = {
    # ChatInput component (wfx)
    "f701f686b325": KnownComponent(  # pragma: allowlist secret
        code_hash="f701f686b325",  # pragma: allowlist secret
        module="wfx.components.input_output.chat.ChatInput",
        description="Chat Input component",
    ),
    # ChatOutput component (wfx)
    "9647f4d2f4b4": KnownComponent(
        code_hash="9647f4d2f4b4",
        module="wfx.components.input_output.chat_output.ChatOutput",
        description="Chat Output component",
    ),
    # LanguageModelComponent (wfx)
    "bb5f8714781b": KnownComponent(
        code_hash="bb5f8714781b",
        module="wfx.components.models.language_model.LanguageModelComponent",
        description="Language Model component",
    ),
    # Note: PromptComponent (primeagent.components.prompts.prompt) is NOT included
    # because the module doesn't exist in the wfx package - it must be compiled
    # from custom code.
    #
    # Docling components (wfx-docling bundle)
    # Note: Some workflows use custom_components.docling_serve which requires
    # custom_code compilation. The wfx_docling DoclingRemoteComponent provides
    ...
    "d76b3853ceb4": KnownComponent(  # pragma: allowlist secret
        ...
        module="wfx_docling.components.docling.docling_inline.DoclingInlineComponent",
        description="Docling inline document processing (local/sidecar)",
        aliases=("wfx.components.docling.docling_inline.DoclingInlineComponent",),
    ),
    "26eeb513dded": KnownComponent(
        code_hash="26eeb513dded",
        module="wfx_docling.components.docling.docling_remote.DoclingRemoteComponent",
        description="Docling remote processing via docling-serve API",
        aliases=("wfx.components.docling.docling_remote.DoclingRemoteComponent",),
    ),
    ...
    "5723576d00e5": KnownComponent(
        ...
        aliases=("wfx.components.docling.docling_remote.DoclingRemoteComponent", "custom_components.docling_serve"),
    ),
    "397fa38f89d7": KnownComponent(
        code_hash="397fa38f89d7",
        module="wfx_docling.components.docling.chunk_docling_document.ChunkDoclingDocumentComponent",
        description="Chunk DoclingDocument for RAG pipelines",
        aliases=("wfx.components.docling.chunk_docling_document.ChunkDoclingDocumentComponent",),
    ),
    "4de16ddd37ac": KnownComponent(
        code_hash="4de16ddd37ac",
        module="wfx_docling.components.docling.export_docling_document.ExportDoclingDocumentComponent",
        description="Export DoclingDocument to markdown, html or other formats",
        aliases=("wfx.components.docling.export_docling_document.ExportDoclingDocumentComponent",),
    ),
    # EmbeddingModel component (wfx)
    "0e2d6fe67a26": KnownComponent(
        code_hash="0e2d6fe67a26",
        module="wfx.components.models_and_agents.embedding_model.EmbeddingModelComponent",
...
def module_to_path(module: str) -> str:
    ...
    Example: "wfx_docling.components.docling.DoclingInlineComponent"
          -> "wfx_docling/components/docling/DoclingInlineComponent"
