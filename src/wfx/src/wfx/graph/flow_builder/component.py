...
from wfx.graph.flow_builder._utils import node_id as _node_id
...
def _normalize_outputs(node_data: dict) -> None:
    ...
    endpoint, the WFX dataclass deserializer — expect the full 13-field Output
    shape (see ``wfx.template.field.base.Output``). Partial entries crash with
