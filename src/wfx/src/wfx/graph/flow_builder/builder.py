...
from wfx.graph.flow_builder.component import add_component, configure_component
from wfx.graph.flow_builder.connect import add_connection
from wfx.graph.flow_builder.flow import empty_flow
from wfx.graph.flow_builder.layout import layout_flow
from wfx.graph.flow_builder.spec import parse_flow_spec, validate_spec_references
...
def load_local_registry() -> dict[str, dict]:
    ...
    try:
        ...
        msg = f"Component registry not found at {_INDEX_PATH}. The wfx package may be installed incorrectly."
