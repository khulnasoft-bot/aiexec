...
class SecuritySettings(BaseModel):
    ...
    Note: PRIMEAGENT_COMPONENTS_PATH and PRIMEAGENT_COMPONENTS_INDEX_PATH can be used to define
    ...
    """If set to False, PRIMEAGENT_COMPONENTS_PATH and PRIMEAGENT_COMPONENTS_INDEX_PATH will
