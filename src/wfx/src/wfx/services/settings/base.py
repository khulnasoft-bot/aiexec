"""Composed ``Settings`` class for Primeagent.

Fields live in per-group mixins under :mod:`wfx.services.settings.groups`.
...
from wfx.constants import BASE_COMPONENTS_PATH as BASE_COMPONENTS_PATH  # noqa: PLC0414  # re-export for back-compat
from wfx.services.settings.groups import (
    CacheSettings,
    ComponentsSettings,
    DatabaseSettings,
    McpSettings,
