...
from wfx.services.adapters.payload import AdapterPayload, PayloadSlot, ProviderPayloadSchemas
...
class DeploymentPayloadFields(ProviderPayloadSchemas):
    ...
    - Primeagent mappers populate ``DeploymentApiPayloads`` (API-side contracts)
    """
