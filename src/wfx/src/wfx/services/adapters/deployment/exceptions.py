"""Framework-agnostic deployment exceptions for WFX deployment service.
...
class DeploymentNotConfiguredError(DeploymentError):
    ...
    The stub :class:`~wfx.services.adapters.deployment.service.DeploymentService` raises
...
def http_status_for_deployment_error(exc: DeploymentServiceError) -> int:
    ...
    Order mirrors the except-chain priority in the Primeagent route layer:
