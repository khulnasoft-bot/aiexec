...
from wfx.services.adapters.deployment.payloads import (
    T_ConfigItemData,
    T_ConfigListParams,
    T_ConfigListResult,
    T_DeploymentConfig,
...
from wfx.services.adapters.payload import AdapterPayload
...
class DeploymentType(str, Enum):
    """Core deployment types recognized by WFX contracts.

    **Cross-package coupling** — primeagent's ``Deployment`` database model
    (``primeagent.services.database.models.deployment.model``) persists this
...
class SnapshotDeploymentBindingUpdate(BaseModel, Generic[T_FlowProviderData]):
    ...
    def validate_operations(self):
        ...
        # add_raw_payloads carry flow-artifact IDs (Primeagent domain),
