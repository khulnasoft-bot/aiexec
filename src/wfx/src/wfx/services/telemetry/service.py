...
from wfx.services.telemetry.base import BaseTelemetryService
from wfx.services.telemetry.schema import (
    ExceptionPayload,
    MCPToolPayload,
    ShutdownPayload,
    VersionPayload,
...
_DEFAULT_BASE_URL = "https://primeagent.gateway.scarf.sh"
...
class TelemetryService(BaseTelemetryService):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self.base_url = base_url or os.environ.get("PRIMEAGENT_TELEMETRY_BASE_URL", _DEFAULT_BASE_URL)
        ...
        self._common_fields = {
            "primeagent_version": self._get_version(),
            "platform": "mcp",
