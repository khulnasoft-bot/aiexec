...
class ServiceManager:
    ...
    async def teardown(self) -> None:
        ...
        try:
            from wfx.services.adapters.registry import teardown_all_adapter_registries
    ...
    def _discover_from_entry_points(self) -> None:
        ...
        try:
            ...
            logger.exception(
                "Failed to enumerate entry points for group='wfx.services'. "
    ...
    def _discover_from_config(self, config_dir: Path) -> None:
        ...
        source = get_preferred_config_source(
            config_dir,
            wfx_root_path=("services",),
            pyproject_root_path=("tool", "wfx", "services"),
        )
        if source is None:
            return
    ...
    def _load_services_from_config(self, config_path: Path, root_path: tuple[str, ...]) -> None:
        ...
        if config_path.name == "wfx.toml" or services:
