...
def _get_lf_version() -> str | None:
    """Return the installed Primeagent version string, or *None* if not installed.
    ...
    for pkg in ("primeagent-base", "primeagent", "primeagent-base-nightly", "primeagent-nightly"):
        try:
            return version(pkg)
