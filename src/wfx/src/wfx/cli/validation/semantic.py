"""Semantic validation checks for Primeagent flow JSON.
...
# ---------------------------------------------------------------------------
# Level 2 - component existence (loads wfx component registry)
# ---------------------------------------------------------------------------


def _check_component_existence(flow: dict[str, Any], result: ValidationResult) -> None:
    try:
        from wfx.interface.utils import initialize_components  # type: ignore[import-untyped]
