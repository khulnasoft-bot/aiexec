"""Constants for field typing used throughout wfx package."""
...
try:
    ...
    # and crashed `primeagent --version` on fresh Windows installs.
    class AgentExecutor:
        pass
...
# Import wfx schema types (avoid circular deps)
from wfx.schema.data import JSON, Data
from wfx.schema.dataframe import DataFrame, Table
