...
if TYPE_CHECKING:
    from wfx.components.codeagents.codeact_agent_smolagents import CodeActAgentSmolagentsComponent
    from wfx.components.codeagents.open_ds_star_agent import OpenDsStarAgentComponent
