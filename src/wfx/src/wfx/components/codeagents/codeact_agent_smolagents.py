...
class CodeActAgentSmolagentsComponent(ToolCallingAgentComponent):
    ...
    async def run_agent(self, agent: Runnable) -> Message:
        ...
        from wfx.schema.content_types import CodeContent, TextContent
        from wfx.schema.message import Message
        ...
        try:
            ...
            # This is critical for real-time updates in Primeagent
            while True:
                try:
    ...
    def _normalize_llm_model(llm_model):
        """Normalize incoming PrimeAgent LLMs to a format acceptable by CodeActAgentSmolagents."""
        from langchain_core.language_models import BaseChatModel, BaseLanguageModel

        # Accept all PrimeAgent model forms directly.
    ...
    def create_agent_runnable(self) -> Runnable:
        ...
        # Filter out invalid tools (empty strings, None, whitespace) that Primeagent might pass
