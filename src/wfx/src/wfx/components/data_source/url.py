...
from wfx.utils.ssrf_protection import SSRFProtectionError, is_ssrf_protection_enabled, validate_and_resolve_url
from wfx.utils.ssrf_transport import create_ssrf_protected_client
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.prime.khulnasoft.com/url"
