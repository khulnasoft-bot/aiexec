...
memory issues, and outputs Data objects suitable for feeding into any Primeagent
...
from wfx.io import HandleInput, IntInput, Output, StrInput
...
class FileDescriptionGeneratorComponent(Component):
    ...
    def _serialize_llm(self) -> dict:
        ...
        from wfx.base.data.docling_utils import _serialize_pydantic_model
    ...
    def generate_descriptions(self) -> list[Data]:
        try:
            ...
            script = textwrap.dedent("""\
                ...
                from wfx.base.data.docling_utils import _deserialize_pydantic_model
