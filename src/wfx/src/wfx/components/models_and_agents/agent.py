...
from wfx.components.models_and_agents.agent_helpers.graph_event_adapter import (
    adapt_graph_events_to_executor_shape,
)
from wfx.components.models_and_agents.agent_helpers.messages_input_builder import (
...
from wfx.components.models_and_agents.memory import MemoryComponent, aget_agent_chat_history
...
from wfx.base.agents.default_system_prompt import DEFAULT_SYSTEM_PROMPT_TEMPLATE
from wfx.base.agents.events import ExceptionWithMessageError, process_agent_events
from wfx.base.agents.token_callback import TokenUsageCallbackHandler
...
from wfx.components.agentics.helpers.model_config import validate_model_selection
from wfx.components.helpers import CalculatorComponent, CurrentDateComponent
from wfx.components.langchain_utilities.ibm_granite_handler import is_watsonx_model
...
class AgentComponent(ToolCallingAgentComponent):
    ...
    async def run_agent(self, agent) -> Message:
        ...
        (in `wfx.base.agents.events`) can be reused unchanged.
        """
        ...
        # Stream tokens to the event manager when running inside the Primeagent runtime.
    ...
    async def json_response(self) -> Data:
        ...
        """
        from wfx.components.models_and_agents.structured_output.structured_output_orchestrator import (
