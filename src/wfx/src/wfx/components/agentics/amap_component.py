...
from wfx.components.agentics.helpers import (
    build_schema_fields,
    prepare_llm_from_component,
)
from wfx.components.agentics.inputs import (
    get_generated_fields_input,
    get_model_provider_inputs,
)
from wfx.components.agentics.inputs.base_component import BaseAgenticComponent
from wfx.io import (
    BoolInput,
    DataFrameInput,
    MessageTextInput,
...
class AMapComponent(BaseAgenticComponent):
    ...
    documentation: str = "https://docs.prime.khulnasoft.com/bundles-agentics"
    icon = "Agentics"
