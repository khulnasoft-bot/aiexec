...
# This allows imports like: import wfx.components.knowledge_bases.retrieval
_redirected_submodules = {
    "wfx.components.knowledge_bases.retrieval": "wfx.components.files_and_knowledge.retrieval",
}
...
def __getattr__(attr_name: str) -> Any:
    ...
    if attr_name == "retrieval":
        ...
        result = import_module("wfx.components.files_and_knowledge.retrieval")
    ...
    package = "wfx.components.files_and_knowledge"
    try:
