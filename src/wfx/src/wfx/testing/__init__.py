"""pytest plugin providing flow_runner fixtures for local Primeagent flow execution.
...
environment variables::
    ...
    pytest --wfx-env-file .env --wfx-timeout 60 tests/

Per-test overrides via markers::

    @pytest.mark.wfx_env_file(".env.test")
    @pytest.mark.wfx_timeout(30)
...
from wfx.testing.plugin import (
    _SKIP_NO_REMOTE,
    _get_marker_arg,
