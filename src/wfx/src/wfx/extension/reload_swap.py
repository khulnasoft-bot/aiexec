...
Why this lives in its own module:
    ...
    that mutates the live ``_wfx_ext.*`` namespace, and
...
:func:`wfx.extension.reload.reload_bundle` for the surrounding pipeline.
"""
...
if TYPE_CHECKING:
    ...
    from wfx.extension.loader import LoadedComponent
