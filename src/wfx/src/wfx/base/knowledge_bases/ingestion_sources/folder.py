...
Intended for Primeagent Desktop and self-hosted deployments where the
...
# Matches ``wfx.base.data.utils.extract_text_from_bytes`` dispatch table.
    ...
    async def validate_config(self) -> None:
        ...
        if not allowed_roots:
            msg = (
                ...
                "PRIMEAGENT_KB_ALLOWED_FOLDER_ROOTS or pass 'allowed_roots' in source_config."
            )
            raise ValueError(msg)
