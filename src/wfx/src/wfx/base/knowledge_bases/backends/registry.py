...
from wfx.base.knowledge_bases.backends.base import BackendType
...
if TYPE_CHECKING:
    ...
    from wfx.base.knowledge_bases.backends.base import BaseVectorStoreBackend
...
def create_backend(
    ...
    *,
    ...
    through Primeagent's ``variable_service`` (same pattern as the connector
