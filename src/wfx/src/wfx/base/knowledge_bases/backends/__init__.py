...
Provides a thin wrapper over LangChain's ``VectorStore`` base so Primeagent's KB
...
from wfx.base.knowledge_bases.backends.astra import AstraBackend
...
from wfx.base.knowledge_bases.backends.chroma import (
    ChromaBackend,
    ChromaCloudBackend,
    ChromaLocalBackend,
)
from wfx.base.knowledge_bases.backends.mongodb import MongoDBBackend
from wfx.base.knowledge_bases.backends.opensearch import OpenSearchBackend
from wfx.base.knowledge_bases.backends.postgres import PostgresBackend
from wfx.base.knowledge_bases.backends.registry import (
    create_backend,
    get_backend_class,
    register_backend,
    registered_backends,
