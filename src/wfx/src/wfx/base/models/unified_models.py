...
from wfx.base.models.model_utils import _to_str, replace_with_live_models
...
_MODEL_CLASS_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "ChatGoogleGenerativeAIFixed": ("wfx.base.models.google_generative_ai_model", "ChatGoogleGenerativeAIFixed"),
