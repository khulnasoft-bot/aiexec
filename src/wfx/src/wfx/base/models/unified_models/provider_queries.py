...
from wfx.base.models.ollama_constants import (
...
def get_models_detailed() -> list[list[dict]]:
    ...
    When ``wfx.base.models.models_dev_catalog`` has an active snapshot
    ...
    from wfx.base.models.models_dev_catalog import apply_models_dev_overrides, get_active_snapshot
