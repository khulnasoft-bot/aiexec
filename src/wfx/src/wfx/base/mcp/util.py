...
def _unwrap_primeagent_json_value(value: Any) -> Any:
    """Return the payload dict from Primeagent JSON/Data values wired into MCP object parameters."""
...
def _try_convert_value(value: Any, expected_type: type, field_name: str, tool_name: str) -> Any:
    ...
    if expected_type in (dict, list):
        value = _unwrap_primeagent_json_value(value)
...
# TODO(khulnasoft/primeagent#12541-followup): MCPSessionManager lives in this
