"""Async HTTP client for Primeagent REST API.
...
class PrimeagentClient:
    """Async HTTP client for Primeagent's REST API.
    ...
    def __init__(
        ...
        self.server_url = (server_url or os.environ.get("PRIMEAGENT_SERVER_URL", "http://localhost:7860")).rstrip("/")
        self.api_key = api_key or os.environ.get("PRIMEAGENT_API_KEY")
