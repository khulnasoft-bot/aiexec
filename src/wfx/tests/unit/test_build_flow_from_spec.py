"""Tests for wfx.graph.flow_builder.builder and flow_to_spec_summary.
...
"""
        ...
        # Each node should have proper Primeagent structure
...
class TestLoadLocalRegistryEncoding:
    ...
    def test_should_load_registry_when_system_default_encoding_is_cp1252(self, monkeypatch):
        ...
        from wfx.graph.flow_builder import builder as builder_module
