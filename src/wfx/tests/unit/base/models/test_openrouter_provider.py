...
def test_openrouter_in_provider_registry():
    from wfx.base.models.model_metadata import LIVE_MODEL_PROVIDERS, MODEL_PROVIDER_METADATA
...
def test_openrouter_metadata_shape():
    from wfx.base.models.model_metadata import MODEL_PROVIDER_METADATA
...
def test_openrouter_appears_in_get_model_providers():
    from wfx.base.models.unified_models import get_model_providers
...
def test_fetch_live_openrouter_models_defaults_intersect_with_seed_list():
    ...
    """
    from wfx.base.models import model_utils
    from wfx.base.models.openrouter_constants import OPENROUTER_MODELS_DETAILED
...
def test_fetch_live_openrouter_models_defaults_fall_back_when_no_seed_overlap():
    ...
    """
    from wfx.base.models import model_utils
    from wfx.base.models.model_utils import MIN_DEFAULT_MODELS
...
def test_validate_provider_uses_requested_model_name():
    ...
    with (
        ...
        patch("wfx.base.models.unified_models.model_catalog.get_unified_models_detailed", return_value=catalog),
    ):
...
def test_get_llm_for_openrouter_sets_base_url_and_headers():
    from wfx.base.models import unified_models as unified_models_module
    from wfx.base.models.unified_models.instantiation import get_llm
