...
Covers:
  ...
  - apply_models_dev_overrides: translates fields, replaces covered providers,
    preserves uncovered providers (IBM WatsonX), passes through Primeagent-only
...
def test_apply_overrides_replaces_covered_provider():
    from wfx.base.models.models_dev_catalog import apply_models_dev_overrides
...
def test_get_unified_models_detailed_sorts_provider_lists():
    ...
    """
    from wfx.base.models import models_dev_catalog
    from wfx.base.models.unified_models.model_catalog import get_unified_models_detailed
