...
class TestDescribeFlowIO:
    ...
    def _run(self):
        from wfx.mcp.flow_builder_tools import DescribeFlowIO
...
class TestProposeFieldEditReadableSummary:
    ...
    def test_summary_is_single_line_unescaped_and_capped(self):
        from wfx.mcp.flow_builder_tools import ProposeFieldEdit, drain_flow_events
...
class TestApplyEditsLiveHeadless:
    ...
    def setup_method(self):
        from wfx.mcp.flow_builder_tools import reset_working_flow
    ...
    def test_propose_field_edit_stays_a_pending_proposal_when_disabled(self):
        ...
        from wfx.mcp.flow_builder_tools import ProposeFieldEdit, _ensure_working_flow, init_working_flow
...
class TestBuildFlowFromSpec:
    ...
    def test_build_mutates_working_flow_in_place_not_rebind(self):
        ...
        from wfx.mcp.flow_builder_tools import _ensure_working_flow
...
class TestConfigureComponentModelProviderOnly:
    ...
    def test_should_resolve_provider_default_name_when_model_name_is_missing(self):
        from wfx.mcp.flow_builder_tools import ConfigureComponent, _ensure_working_flow
    ...
    def test_should_preserve_an_explicitly_named_model(self):
        from wfx.mcp.flow_builder_tools import ConfigureComponent
...
class TestConnectComponents:
    ...
    def test_connect_updates_source_selected_output_when_multiple_outputs(self):
        ...
        """  # noqa: D205
        from wfx.mcp.flow_builder_tools import _ensure_working_flow, _find_node
...
class TestConfigureProposeConversion:
    ...
    def test_text_field_edit_on_existing_component_becomes_edit_field_proposal(self):
        from wfx.mcp.flow_builder_tools import set_propose_existing_edits
...
class TestConnectToolModeFlipPropagation:
    ...
    def test_emits_enable_tool_mode_with_flipped_outputs(self):
        from wfx.mcp.flow_builder_tools.mutate_tools import _emit_source_tool_mode_if_flipped
