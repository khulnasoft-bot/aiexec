...
from wfx.extension.migration import loader as loader_mod
from wfx.extension.migration.loader import (
...
@pytest.mark.unit
def test_canonical_path_lives_in_wfx_package() -> None:
    """Sanity: the canonical path is inside the wfx wheel layout."""
