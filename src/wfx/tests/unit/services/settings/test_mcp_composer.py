...
class TestBackendAuthToken:
    """Test internal Composer-to-Primeagent backend authentication config."""
    ...
    async def test_oauth_startup_uses_config_path_for_backend_auth(self, mcp_service):
        ...
        with (
            patch("wfx.services.mcp_composer.service.get_settings_service", return_value=mock_settings),
            patch.object(
                mcp_service,
