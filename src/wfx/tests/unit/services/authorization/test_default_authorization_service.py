"""Tests for the default WFX AuthorizationService (no-op allow-all implementation)."""
...
async def test_is_enabled_returns_false(service: AuthorizationService) -> None:
    """The WFX default reports authorization as disabled."""
...
async def test_invalidate_user_is_noop(service: AuthorizationService) -> None:
    """Cache invalidation hooks are no-ops on the default WFX implementation."""
