...
def _discover_all_component_classes() -> list[tuple[str, type]]:
    """Discover all component classes from the wfx.components package.

    Finds all .py files under wfx/components, imports them, and collects
    ...
    components_pkg_path = Path(wfx.components.__path__[0])
    components_pkg_name = wfx.components.__name__
