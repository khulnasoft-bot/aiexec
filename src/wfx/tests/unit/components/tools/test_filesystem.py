...
class TestReadFile:
    ...
    def test_should_reject_read_when_file_exceeds_size_limit(
        ...
        from wfx.components.files_and_knowledge import filesystem as fs_mod
...
class TestToolModeToggle:
    ...
    def test_should_have_at_least_one_input_with_tool_mode_true(self, component: FileSystemToolComponent) -> None:
        ...
        # wfx.template.utils — without this, the "Tool Mode" header toggle does
...
# replaced the legacy PRIMEAGENT_FS_TOOL_ALLOWED_ROOTS env var and the Astra cloud
...
# PRIMEAGENT_FS_TOOL_BASE_DIR + AUTO_LOGIN dispatch — covered by
...
class TestEmptyRootPathDoesNotLeakCwd:
    ...
    def test_should_anchor_empty_sub_path_to_base_not_cwd_in_shared_mode(
        ...
        base = tmp_path / "base"
        monkeypatch.setenv("PRIMEAGENT_FS_TOOL_BASE_DIR", str(base))
