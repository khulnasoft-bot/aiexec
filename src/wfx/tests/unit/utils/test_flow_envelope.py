"""Unit tests for the shared flow-envelope helpers (wfx.utils.flow_envelope).

These back the outer-envelope handling used by `wfx run`, `wfx serve`, `wfx upgrade`, and the
