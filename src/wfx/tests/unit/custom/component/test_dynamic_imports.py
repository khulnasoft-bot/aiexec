...
class TestImportUtils:
    ...
    def test_import_mod_with_module_name(self):
        ...
        with pytest.raises(ModuleNotFoundError, match="No module named"):
            import_mod("OpenAIModelComponent", "openai_chat_model", "wfx.components.openai")

    def test_import_mod_without_module_name(self):
        """Test importing entire module when module_name is None."""
        result = import_mod("models_and_agents", "__module__", "wfx.components")
    ...
    def test_import_mod_module_not_found(self):
        ...
        with pytest.raises(ImportError, match="not found"):
            import_mod("NonExistentComponent", "nonexistent_module", "wfx.components.openai")
    ...
    def test_import_mod_attribute_not_found(self):
        ...
        with pytest.raises(ModuleNotFoundError, match="No module named"):
            import_mod("NonExistentComponent", "openai_chat_model", "wfx.components.openai")
...
class TestComponentDynamicImports:
    ...
    def test_category_module_dynamic_import(self):
        ...
        import wfx.components.openai as openai_components
    ...
    def test_multiple_category_modules(self):
        ...
        import wfx.components.anthropic as anthropic_components
        import wfx.components.data as data_components
    ...
    def test_backward_compatibility(self):
        ...
        from wfx.components import data
        ...
        from wfx.components import helpers
    ...
    def test_import_error_handling(self):
        ...
        import wfx.components.notdiamond as notdiamond_components

        # Patch the import_mod function directly
        with patch("wfx.components.notdiamond.import_mod") as mock_import_mod:
    ...
    def test_type_checking_imports(self):
        ...
        import wfx.components.searchapi as searchapi_components
...
class TestPerformanceCharacteristics:
    ...
    def test_lazy_loading_performance(self):
        ...
        from wfx.components import chroma as chromamodules
    ...
    def test_memory_usage_multiple_accesses(self):
        ...
        from wfx.components import processing
...
class TestSpecialCases:
    ...
    def test_platform_specific_components(self):
        ...
        import wfx.components.nvidia as nvidia_components
