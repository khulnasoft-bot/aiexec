...
git clone https://github.com/khulnasoft-bot/primeagent
...
wfx supports a pluggable service architecture that allows you to customize and extend its behavior. You can replace built-in services (storage, telemetry, tracing, etc.) with your own implementations or use Primeagent's full-featured services.
...
- Using full-featured Primeagent services in wfx
