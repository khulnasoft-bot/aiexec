...
test("should be able to see output preview from grouped components and connect components with a single click", {
  ...
  expect(
    await page.getByTestId("output-inspection-combined text-groupnode").first(),
  ).not.toBeDisabled();
  await page
