...
test.describe("ModelProviderModal", () => {
  test("should open model provider page from settings", {
  ...
  test("should display provider list in page", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page, { skipModal: true });
  ...
  test("should show provider details when a provider is selected", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page, { skipModal: true });
  ...
  test("should navigate back from model provider page", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page, { skipModal: true });
  ...
  test("should display model selection panel for enabled provider", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page, { skipModal: true });
  ...
  test("should have accessible page structure", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page, { skipModal: true });
  ...
  test("should navigate to model provider page multiple times", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page, { skipModal: true });
