...
test.describe("Bulk Delete Sessions", () => {
  ...
  test("should show Select All checkbox when multiple sessions exist", {
  ...
  test("should select all sessions when Select All checkbox is clicked", {
    tag: ["@release", "@features"],
  }, async ({ page }) => {
    test.skip(
      !process?.env?.OPENAI_API_KEY,
  ...
  test("should deselect all sessions when Select All is clicked again", {
    tag: ["@release", "@features"],
  }, async ({ page }) => {
    test.skip(
      !process?.env?.OPENAI_API_KEY,
  ...
  test("should allow individual session selection", {
    tag: ["@release", "@features"],
  }, async ({ page }) => {
    test.skip(
      !process?.env?.OPENAI_API_KEY,
  ...
  test("should use bulk delete API endpoint for multiple sessions", {
  ...
  test("should delete all sessions including current and create new default session", {
    tag: ["@release", "@features"],
  }, async ({ page }) => {
    test.skip(
      !process?.env?.OPENAI_API_KEY,
  ...
  test("should hide checkboxes and Select All when only one session exists", {
    tag: ["@release", "@features"],
  }, async ({ page }) => {
    test.skip(
      !process?.env?.OPENAI_API_KEY,
