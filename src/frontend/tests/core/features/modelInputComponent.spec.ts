...
test.describe("ModelInputComponent", () => {
  test("should display model selector in a node with model input", {
  ...
  test("should open model dropdown and show providers", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page);
  ...
  test("should show Manage Model Providers button in dropdown", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page);
  ...
  test("should open Model Provider Modal from dropdown", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page);
  ...
  test("should show Refresh List button in dropdown", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page);
  ...
  test("should display selected model in trigger button", {
    tag: ["@release", "@components", "@workspace"],
  }, async ({ page }) => {
    await awaitBootstrapTest(page);
