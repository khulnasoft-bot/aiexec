...
test("user should be able to use query input", {
  ...
  newCode = newCode.replace(
    ...
    `from wfx.inputs.inputs import BoolInput, DictInput, DropdownInput, IntInput, SecretStrInput, SliderInput, StrInput, QueryInput`,
  );
