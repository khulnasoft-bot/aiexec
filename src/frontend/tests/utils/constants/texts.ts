...
export const TEXTS = {
  ...
  // ─── Auth / login screen ────────────────────────────────────────────
  /** Visible on the sign-in route when PRIMEAGENT_AUTO_LOGIN=false. */
  authSignInHeader: "sign in to primeagent",
  /** Default seeded username/password ("primeagent"/"primeagent"). */
  authDefaultCredential: "primeagent",
