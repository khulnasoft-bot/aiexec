...
test("user should be able to drag and drop an old collection without crashing the application", {
...
test("user should be able to drag and drop a flow on main page", {
  tag: ["@release"],
}, async ({ page }) => {
  await awaitBootstrapTest(page);
