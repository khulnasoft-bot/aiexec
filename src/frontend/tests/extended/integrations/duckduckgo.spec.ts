...
test("user should be able to use duckduckgo search component", {
  ...
  await page.waitForSelector('[data-testid="disclosure-bundles-duckduckgo"]', {
    timeout: 3000,
  });
  ...
  await page
    ...
    .hover()
    .then(async () => {
      await page.getByTestId("add-component-button-duckduckgo-search").click();
    });
  await adjustScreenView(page);

  await page
    .getByTestId("popover-anchor-input-input_value")
    .fill("what is primeagent?");
