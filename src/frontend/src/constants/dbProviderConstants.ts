...
export const ACTIVE_DB_PROVIDER_VARIABLE = "PRIMEAGENT_KNOWLEDGE_BACKEND";
...
export const DB_PROVIDER_OPTIONS: DBProviderOption[] = [
  {
    ...
    label: "Chroma Local",
    description:
      "Local vector storage bundled with Primeagent. No additional configuration required.",
    icon: "Chroma",
    status: "available",
    defaultEnabled: true,
    configFields: [],
  ...
  },
  {
    ...
    configFields: [
      ...
      },
      {
        ...
        required: true,
        isSecret: false,
        placeholder: "primeagent_knowledge",
      },
      {
