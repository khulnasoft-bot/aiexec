  ...
  return JSON.stringify(
    {
      mcpServers: {
        primeagent: {
          ...
          env: {
            PRIMEAGENT_SERVER_URL: serverUrl,
            PRIMEAGENT_API_KEY: "YOUR_API_KEY", // pragma: allowlist secret
          },
        },
      },
    },
...
function getClaudeCodeCommand(serverUrl: string): string {
  return `claude mcp add primeagent -- uvx --from wfx wfx-mcp \\
  -e PRIMEAGENT_SERVER_URL=${serverUrl} \\
  -e PRIMEAGENT_API_KEY=YOUR_API_KEY`;
}
