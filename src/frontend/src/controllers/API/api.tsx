  ...
  useEffect(() => {
    ...
    const isAuthorizedURL = (url) => {
      const authorizedDomains = [
        "https://raw.githubusercontent.com/khulnasoft/primeagent_examples/main/examples",
        "https://api.github.com/repos/khulnasoft/primeagent_examples/contents/examples",
