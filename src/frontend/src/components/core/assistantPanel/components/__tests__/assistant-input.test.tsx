...
jest.mock("../../assistant-panel.constants", () => ({
  getAssistantPlaceholder: () => "Ask me anything about Primeagent...",
}));
...
describe("AssistantInput", () => {
  ...
  describe("rendering", () => {
    it("should render textarea with idle placeholder", () => {
      ...
      expect(
        screen.getByPlaceholderText("Ask me anything about Primeagent..."),
      ).toBeInTheDocument();
    });
  ...
  describe("send button state", () => {
    ...
    it("should be enabled when message has content and not disabled", async () => {
      ...
      localStorage.setItem(
        "primeagent-assistant-selected-model",
        JSON.stringify({
          id: "OpenAI-gpt-4o",
          name: "gpt-4o",
          provider: "OpenAI",
  ...
  describe("command history (arrow-up / arrow-down)", () => {
    const STORAGE_KEY = "primeagent-assistant-input-history";
