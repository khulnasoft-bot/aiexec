...
import primeagentAssistantIcon from "@/assets/primeagent_assistant.svg";
import primeagentAssistantIdleIcon from "@/assets/primeagent_assistant_idle.svg";
...
// Delay before the "Try the new Primeagent Assistant!" tooltip surfaces, in ms.
            ...
            <div className="group relative">
              ...
              >
                {/* Idle state — uses the design-tuned
                    ``primeagent_assistant_idle.svg`` (noise filter + brand tint
                    baked into the SVG). Hidden whenever the panel is open so
                    the button reads as "active" alongside the open panel. */}
                <img
                  src={primeagentAssistantIdleIcon}
                  alt="Primeagent Assistant"
          ...
          <PopoverPrimitive.Portal>
            ...
            >
              ...
              <button
                ...
                aria-label="Open Primeagent Assistant"
