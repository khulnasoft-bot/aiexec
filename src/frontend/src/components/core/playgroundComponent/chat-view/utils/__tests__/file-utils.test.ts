...
describe("file-utils", () => {
  ...
  describe("getFilePreviewUrl", () => {
    ...
    describe("Windows path normalization and URL construction", () => {
      ...
      it("should_not_treat_primeagent_substrings_as_special_path_segments", () => {
        const windowsPath = "C:\\temp\\primeagent-report\\flow123\\image.png";
        const expected =
          "http://localhost:3000/api/v1/files/images/C%3A/temp/primeagent-report/flow123/image.png";
