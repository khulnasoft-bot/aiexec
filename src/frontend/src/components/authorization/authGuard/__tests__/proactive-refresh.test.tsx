...
// Mirrors the mocked PRIMEAGENT_ACCESS_TOKEN_EXPIRE_SECONDS below (seconds → ms).
...
jest.mock("@/constants/constants", () => ({
  IS_AUTO_LOGIN: true,
  PRIMEAGENT_ACCESS_TOKEN_EXPIRE_SECONDS: 3240,
  PRIMEAGENT_ACCESS_TOKEN_EXPIRE_SECONDS_ENV: Number.NaN,
}));
