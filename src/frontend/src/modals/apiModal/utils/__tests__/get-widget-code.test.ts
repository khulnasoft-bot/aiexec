...
describe("getWidgetCode", () => {
  ...
  describe("Basic widget code generation", () => {
    it("should generate widget code with API key when isAuth is false", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/khulnasoft/primeagent-embedded-chat",
      );
      expect(code).toContain("@v1.0.8");
      expect(code).toContain("</script>");

      // Check for primeagent-chat component
      expect(code).toContain("<primeagent-chat");
    ...
    it("should generate widget code without API key when isAuth is true", () => {
      ...
      expect(code).toContain("<script");
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/khulnasoft/primeagent-embedded-chat@v1.0.8",
      );
    ...
    it("should use single-line CDN URL when copy is false", () => {
      ...
      expect(code).toContain("src=");
      expect(code).toContain("https://cdn.jsdelivr.net/gh/khulnasoft");
    ...
    it("should use formatted CDN URL when copy is true", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/khulnasoft/primeagent-embedded-chat@v1.0.8/dist/build/static/js/bundle.min.js",
      );
  ...
  describe("Code structure", () => {
    it("should have proper HTML structure with script and primeagent-chat tags", () => {
      const code = getWidgetCode(baseOptions);
      ...
      // Check for opening and closing primeagent-chat tags
      expect(code).toContain("<primeagent-chat");
      expect(code).toContain("</primeagent-chat>");
    });

    it("should have all required attributes in primeagent-chat component", () => {
      const code = getWidgetCode(baseOptions);
