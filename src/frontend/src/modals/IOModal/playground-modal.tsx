//import PrimeagentLogoColor from "@/assets/PrimeagentLogocolor.svg?react";
...
import { PrimeagentButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const PrimeagentButtonClick = () => {
    track("PrimeagentButtonClick");
    customOpenNewTab(PrimeagentButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={PrimeagentButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <PrimeagentLogoColor />
                      <div className="text-sm">
                        {t("modal.io.builtWithPrimeagent")}
                      </div>
                    </Button>
                  </div>
                )}
            ...
            {!sidebarOpen && showPublishOptions && (
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                <ShadTooltip
                  styleClasses="z-50"
                  side="right"
                  content={t("modal.io.builtWithPrimeagentTooltip")}
                >
                  <Button
                    variant="primary"
                    ...
                    onClick={PrimeagentButtonClick}
                  >
                    <PrimeagentLogoColor className="h-[18px] w-[18px] scale-150" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
