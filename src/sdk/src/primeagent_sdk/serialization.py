"""Git-friendly flow serialization for primeagent-sdk.

``normalize_flow`` transforms a raw Primeagent flow dict into a stable,
...
def normalize_flow(
    ...
    *,
    ...
    ----------
    flow:
        Raw flow dict as returned by the Primeagent API or read from a ``.json``
        file.
    strip_volatile:
