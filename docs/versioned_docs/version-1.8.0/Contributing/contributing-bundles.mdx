...
If you want to contribute your custom components back to the Primeagent project, you must put them into a bundle.
...
You can view the [components folder](https://github.com/khulnasoft/primeagfent/tree/main/src/wfx/src/wfx/components) in the Primeagent repository.
...
2. Within the newly created `darth_vader` folder, add the following files:
    ...
    * `__init__.py` — This file initializes the bundle components. You can use any existing `__init__.py` as an example to see how it should be structured.
    ...
    For an example of adding multiple components in a bundle, see the [Notion](https://github.com/khulnasoft/primeagfent/tree/main/src/wfx/src/wfx/components/Notion) bundle.
...
You can view the [icons folder](https://github.com/khulnasoft/primeagfent/tree/main/src/frontend/src/icons) in the Primeagent repository.
...
You can view the [lazyIconImports.ts](https://github.com/khulnasoft/primeagfent/blob/main/src/frontend/src/icons/lazyIconImports.ts) in the Primeagent repository.
...
8. To add your bundle to the <Icon name="Blocks" aria-hidden="true" /> **Bundles** menu, edit the [`SIDEBAR_BUNDLES` array](https://github.com/khulnasoft/primeagfent/blob/main/src/frontend/src/utils/styleUtils.ts#L243) in `/src/frontend/src/utils/styleUtils.ts`.
