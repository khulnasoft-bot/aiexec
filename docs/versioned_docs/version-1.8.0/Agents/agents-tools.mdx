...
2. Enter Python code into the **Code** pane to create the custom component.
    ...
    ```python
    from primeagfent.custom import Component
    from primeagfent.io import MessageTextInput, Output
    from primeagfent.schema import Data
    import re

    class TextAnalyzerComponent(Component):
        display_name = "Text Analyzer"
        description = "Analyzes and transforms input text."
        documentation: str = "http://docs.primeagfent.org/components/custom"
        icon = "chart-bar"
