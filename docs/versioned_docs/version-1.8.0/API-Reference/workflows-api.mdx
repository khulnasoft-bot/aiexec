...
url = f"{PRIMEAGFENT_SERVER_URL}/api/v2/workflows"
headers = {
...
const url = `${PRIMEAGFENT_SERVER_URL}/api/v2/workflows`;
...
url = f"{PRIMEAGFENT_SERVER_URL}/api/v2/workflows/stop"
headers = {
    "Content-Type": "application/json",
    "x-api-key": PRIMEAGFENT_API_KEY
}
...
const url = `${PRIMEAGFENT_SERVER_URL}/api/v2/workflows/stop`;
