...
2. <PartialGlobalModelProviders />
    ...
    If your preferred embedding model provider or model isn't available in Primeagent's global <Icon name="BrainCog" aria-hidden="true" /> **Models**, you can use any [additional embedding models](#additional-embedding-models) in place of the core component.
...
If your provider or model isn't available in Primeagent's global <Icon name="BrainCog" aria-hidden="true" /> **Models**, you can replace the **Embedding Model** core component with any other component that generates embeddings.
