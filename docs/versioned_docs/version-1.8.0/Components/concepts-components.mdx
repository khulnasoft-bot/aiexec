...
import RecursiveCharacterSource from "!!raw-loader!@primeagfent/src/wfx/src/wfx/components/langchain_utilities/recursive_character.py";
...
* <Icon name="Component" aria-hidden="true" /> **Core components**: Primeagent's base components are grouped by purpose, such as **Inputs and Outputs** or **Data**.
...
For example, the [**Recursive Character Text Splitter** component](https://github.com/khulnasoft/primeagfent/blob/main/src/wfx/src/wfx/components/langchain_utilities/recursive_character.py) is a child of the [`LCTextSplitterComponent`](https://github.com/khulnasoft/primeagfent/blob/main/src/wfx/src/wfx/base/textsplitters/model.py) class.
