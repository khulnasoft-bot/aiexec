...
The schema is defined in [`data.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/backend/base/primeagfent/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/backend/base/primeagfent/schema/dataframe.py).
...
The `Message` schema is defined in [`message.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/backend/base/primeagfent/schema/message.py).
