---
title: Build components with Primeagent Assistant
slug: /primeagfent-assistant
---

import Icon from "@site/src/components/icon";

**Primeagent Assistant** is an in-app virtual assistant pane within the **Playground**.

It can answer questions about the application and help you get more out of Primeagent.

**Primeagent Assistant** understands the structure of the Primeagent graph, so it can create components from natural language prompts.
...
1. In the **Playground**, click the <Icon name="Primeagent" aria-hidden="true"/> **Primeagent** icon.
