A Primeagent knowledge base is a local vector database that is stored in Primeagent storage.
...
* **Local storage**: Primeagent knowledge bases are exclusively local.
