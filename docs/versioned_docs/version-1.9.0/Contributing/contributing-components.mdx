...
New components are added as objects of the [`Component`](https://github.com/khulnasoft/primeagfent/blob/main/src/wfx/src/wfx/custom/custom_component/component.py) class.

Dependencies are added to the [pyproject.toml](https://github.com/khulnasoft/primeagfent/blob/main/pyproject.toml) file.
...
You can view the [/data/__init__.py](https://github.com/khulnasoft/primeagfent/blob/dev/src/wfx/src/wfx/components/data/__init__.py) in the Primeagent repository.

7. Add any new dependencies to the [pyproject.toml](https://github.com/khulnasoft/primeagfent/blob/main/pyproject.toml#L20) file.

8. Submit documentation for your component. For this example component, you would submit documentation to the [Data components page](https://github.com/khulnasoft/primeagfent/blob/main/docs/docs/Components/components-data.mdx).
