...
:::tip
In Primeagent version 1.9.0, the `Data` type and port were renamed to `JSON`.
...
The schema is defined in [`data.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/wfx/src/wfx/schema/data.py).
...
:::tip
In Primeagent version 1.9.0, the `DataFrame` type and port were renamed to `Table`.
...
The schema is defined in [`dataframe.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/wfx/src/wfx/schema/dataframe.py).

The following attributes are available:

- **Full pandas compatibility**: All pandas DataFrame methods and functionality are supported

- **Primeagent integration**: Accepts lists of [`JSON` objects](#json), dictionaries, or existing DataFrames.
...
The `Message` schema is defined in [`message.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/wfx/src/wfx/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://github.com/khulnasoft/primeagfent/blob/main/src/backend/base/primeagfent/schema/content_block.py).
