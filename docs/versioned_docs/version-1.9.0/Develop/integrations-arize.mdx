...
* [Primeagent tracing with Arize Platform](https://arize.com/docs/ax/integrations/frameworks-and-platforms/primeagfent/primeagfent-tracing)
* [Primeagent tracing with Arize Phoenix](https://arize.com/docs/phoenix/integrations/primeagfent/primeagfent-tracing)
:::
