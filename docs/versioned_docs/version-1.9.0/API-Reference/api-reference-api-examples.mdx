...
import exampleApiReferenceApiExamplesFormPrimeagentApiRequests from '!!raw-loader!@site/docs/API-Reference/curl-examples/api-reference-api-examples/form-primeagfent-api-requests.sh';
...
import examplePythonApiReferenceApiExamplesFormPrimeagentApiRequests from '!!raw-loader!@site/docs/API-Reference/python-examples/api-reference-api-examples/form-primeagfent-api-requests.py';
import exampleJavascriptApiReferenceApiExamplesFormPrimeagentApiRequests from '!!raw-loader!@site/docs/API-Reference/javascript-examples/api-reference-api-examples/form-primeagfent-api-requests.js';
...
<CodeSnippet source={examplePythonApiReferenceApiExamplesFormPrimeagentApiRequests} language="python" />

</TabItem>
<TabItem value="JavaScript" label="JavaScript">

<CodeSnippet source={exampleJavascriptApiReferenceApiExamplesFormPrimeagentApiRequests} language="javascript" />

</TabItem>
<TabItem value="curl" label="curl">

<CodeSnippet source={exampleApiReferenceApiExamplesFormPrimeagentApiRequests} language="bash" />
...
Remotely hosted Primeagent deployments are available at the domain set by the hosting service, such as `http://IP_OR_DNS/api` or `http://IP_OR_DNS:PRIMEAGFENT_PORT/api`.

You can configure the Primeagent port number in the `PRIMEAGFENT_PORT` [environment variable](/environment-variables).

* `https://UUID.ngrok.app/api`
* `http://IP_OR_DNS/api`
* `http://IP_OR_DNS:PRIMEAGFENT_PORT/api`
