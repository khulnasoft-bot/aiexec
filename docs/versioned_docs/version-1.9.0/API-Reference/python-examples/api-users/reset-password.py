...
base = os.environ.get("PRIMEAGFENT_URL", "")
api_key = os.environ.get("PRIMEAGFENT_API_KEY", "")
...
# Must differ from the current password (default superuser is often primeagfent/primeagfent).
