...
For more information, see [Primeagent JSON file contents](#primeagfent-json-file-contents).
...
For example Primeagent JSON files, you can examine any of the https://github.com/khulnasoft/primeagfent/tree/main/src/backend/base/primeagfent/initial_setup/starter_projects[templates in the Primeagent repository], or you can create a flow from a template in Primeagent, export it, and then open the exported JSON file in a text editor.
