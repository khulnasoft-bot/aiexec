...
Instead, download a fresh installation from the [Primeagent website](https://prime.khulnasoft.com) when a new version is available.
...
5. Download the Windows installer from the [Primeagent website](https://prime.khulnasoft.com).
