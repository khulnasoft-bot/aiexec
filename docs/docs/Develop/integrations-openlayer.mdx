...
```bash
export OPENLAYER_PRIMEAGENT_MAPPING='{"Flow Name 1":"pipeline-id-1","Flow Name 2":"pipeline-id-2"}'
```
...
```cmd
set OPENLAYER_PRIMEAGENT_MAPPING={"Flow Name 1":"pipeline-id-1","Flow Name 2":"pipeline-id-2"}
```
