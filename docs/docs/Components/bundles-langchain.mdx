...
[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with Aiexec.
...
For more information, see the [LangChain SQL agent documentation](https://docs.langchain.com/oss/python/tutorials/sql_qa/).
...
For more information, see the [LangChain tool calling documentation](https://docs.langchain.com/oss/python/concepts/tool_calling/).
...
To replace these components, consider other components in the **LangChain** bundle or general Aiexec components, such as the [**Agent** component](/components-agents) or the [**SQL Database** component](/components-data#sql-database).