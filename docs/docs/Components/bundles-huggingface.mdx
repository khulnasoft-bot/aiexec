...
Specifically, the **Language Model** output is an instance of [`HuggingFaceHub`](https://docs.langchain.com/oss/python/integrations/providers/huggingface/) configured according to the component's parameters.
