...
The output is [`Embeddings`](/data-types#embeddings) generated with [`WatsonxEmbeddings`](https://docs.langchain.com/oss/python/integrations/text_embedding/ibm_watsonx/).
