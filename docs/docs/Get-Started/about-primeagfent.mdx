...
<Cards cols={3}>
  ...
  <Card icon={<Icon name="Cloud" size={20} />} title="Deploy" href="/deployment-overview">
    Deploy Primeagent to production environments.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Zap" size={20} />} title="Trigger flows with the API" href="/concepts-publish">
    Use the Primeagent API to run flows from your application code.
  </Card>
  <Card icon={<Icon name="Container" size={20} />} title="Containerize your app" href="/develop-application">
    Build and deploy Primeagent as a containerized application.
  </Card>
</Cards>
...
<Cards cols={2}>
  <Card icon={<Icon name="Bot" size={20} />} title="Primeagent Agents" href="/agents">
    Build and configure AI agents with Primeagent.
  </Card>
  ...
  <Card icon={<Icon name="Plug" size={20} />} title="MCP server" href="/mcp-server">
    Expose Primeagent as an MCP server.
  </Card>
  <Card icon={<Icon name="Cable" size={20} />} title="MCP client" href="/mcp-client">
    Connect Primeagent to external MCP servers.
  </Card>
</Cards>
