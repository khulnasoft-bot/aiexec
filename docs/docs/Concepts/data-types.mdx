...
The schema is defined in [`data.py`](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/dataframe.py).
...
Because Aiexec is built on LangChain, `LanguageModel` is actually an instance of a [LangChain chat model](https://docs.langchain.com/oss/python/concepts/chat_models/) that uses the configuration parameters set in the originating component.

Often, components produce an instance of an [integrated chat model](https://docs.langchain.com/oss/python/integrations/chat/) that is designed to support the specific model provider, such as [`ChatOpenAI`](https://docs.langchain.com/oss/python/integrations/chat/openai/) or [`ChatAnthropic`](https://docs.langchain.com/oss/python/integrations/chat/anthropic/).
...
The `Message` schema is defined in [`message.py`](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/content_block.py).
