...
Primeagent supports both Apple Silicon (ARM64) and Intel (x86_64) Macs, but with different feature availability due to hardware capabilities and upstream dependency support.
...
Install Primeagent normally with all features:
...
- Deploy Primeagent on a cloud instance with GPU support
- Use the Primeagent API to connect from your Intel Mac
...
Primeagent will continue to support core functionality on Intel Macs as long as Python and essential dependencies remain available, but ML features will remain Apple Silicon exclusive.
...
2. **Solution** - Use core Primeagent features or API-based alternatives
...
If Primeagent feels slow on Intel Mac:
...
- [GitHub Discussions](https://github.com/khulnasoft/primeagfent/discussions)
- [Discord Community](https://discord.gg/EqksyE2EX9)
- [Documentation](https://docs.primeagfent.org)