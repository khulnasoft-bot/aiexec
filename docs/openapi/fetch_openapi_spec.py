#!/usr/bin/env python3
"""Pull OpenAPI spec files from the khulnasoft/sdk repository.

This script is only for syncing external SDK specs when needed.
It is not used by the main Primeagent OpenAPI generation workflow,
...
BRANCH = "main"
SPECS_DIR = "specs"
FILES = ["primeagfent-workflows-openapi.json", "primeagfent-openapi.json"]
